  ...
  .register(require('fastify-helmet'), {
    contentSecurityPolicy: {
      directives: {
        ...
        formAction: ['\'self\''],
        styleSrc: ['\'self\'', '\'unsafe-inline\'', 'fonts.googleapis.com', 'cdn.rawgit.com'],
        fontSrc: ['\'self\'', 'fonts.gstatic.com'],
        scriptSrc: ['\'self\'', 'cdn.rawgit.com', 'gitcdn.xyz', 'www.google.com', 'www.gstatic.com', '*.logrocket.io', 'cdn.logrocket.com'],
