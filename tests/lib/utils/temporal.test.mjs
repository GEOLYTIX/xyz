    ...
    codi.describe('Utils: dateTime Test', () => {
        ...
        codi.it('Should throw an error for invalid date strings', () => {
            ...
            invalidDates.forEach(invalidDate => {
                ...
                try {
                    mapp.utils.temporal.dateToUnixEpoch(invalidDate), 'Invalid date string provided';
                } catch (error) {
                    errors.push(error.message);
                }
            });

            codi.assertTrue((errors.length === 9), 'We expect to have 9 errors logged back')
        ...
        codi.it('Should format unix timestamps to date time', () => {
            ...
            codi.assertEqual(datetime, '2024-01-01T00:00:00', 'The datetime should b be the 1st of January 2024')
        ...
        codi.it('Should format unix timestamps to date', () => {
            ...
            codi.assertEqual(datetime, '2024-01-01', 'The datetime should b be the 1st of January 2024')
