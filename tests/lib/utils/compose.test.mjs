...
export function compose() {
    codi.describe({ name: 'Compose Test:', id: 'utils_compose', parentId: 'utils' }, () => {

        /**
         * ### Should compose functions from left to right
         * @function it
         */
        codi.it({ name: 'Should compose functions from left to right', parentId: 'utils_compose' }, () => {
         ...
         * @function it
         */
        codi.it({ name: 'Should work with a single function', parentId: 'utils_compose' }, () => {
            const addTwo = x => x + 2;
         ...
         * @function it
         */
        codi.it({ name: 'Should return the input if no functions are provided', parentId: 'utils_compose' }, () => {
            //Creating the compose chain
         ...
         * @function it
         */
        codi.it({ name: 'Should handle different data types', parentId: 'utils_compose' }, () => {
