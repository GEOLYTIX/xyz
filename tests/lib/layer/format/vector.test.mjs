...
export async function vectorTest(mapview, layer) {
  ...
  await codi.describe('Layer Format: Vector', async () => {
    ...
    codi.it(
      'Should create a wkt layer with a custom featureFormat',
      async () => {
        const custom_config = {
