    ...
    async () => {
      codi.it(
        ...
        async () => {
          ...
          // Check the values 
          codi.assertTrue(
            layer.featureFields['retailer']['A'] === 3, 'Count for retailer A should be 3'
          );

          codi.assertTrue(
            layer.featureFields['retailer']['B'] === 1, 'Count for retailer B should be 1'
          );
        }
      );
      codi.it(
        ...
        async () => {
          ...
          codi.assertTrue(
            layer.featureFields['open_close']['Open'] === 3, 'Count for Open should be 3'
          );

          codi.assertTrue(
            layer.featureFields['open_close']['Close'] === 1, 'Count for Close should be 1'
          );
        }
      );
    }
