...
export function cloudinary() {
    codi.describe({ name: 'Cloudinary test:', id: 'ui_locations_entries_cloudinary', parentId: 'ui_locations_entries' }, () => {

        /**
         * @description Should return image preview
         * @function it
         */
        codi.it({ name: 'Should return cloudinary res url for image preview with trash icon', parentId: 'ui_locations_entries_cloudinary' }, () => {
         ...
         * @function it
         */
        codi.it({ name: 'Should return cloudinary res url for document preview with trash icon', parentId: 'ui_locations_entries_cloudinary' }, () => {
        ...
        * @function it
        */
        codi.it({ name: 'Should return an image grid with trash icons on each', parentId: 'ui_locations_entries_cloudinary' }, () => {
         ...
         * @function it
         */
        codi.it({ name: 'Should return an image with no trash icon', parentId: 'ui_locations_entries_cloudinary' }, () => {
