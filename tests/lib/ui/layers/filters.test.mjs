...
export function filtersTest(mapview) {
    codi.describe({ name: 'Filters test:', id: 'ui_layers_filters', parentId: 'ui_layers' }, async () => {
         ...
         * @function it
         */
        codi.it({ name: 'Numeric Filter: max value specified', parentId: 'ui_layers_filters' }, async () => {
         ...
         * @function it
         */
        codi.it({ name: 'Numeric Filter: layer.current specified as `lte: 200` and `gte: 800`', parentId: 'ui_layers_filters' }, async () => {
