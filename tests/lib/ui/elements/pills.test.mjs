...
export function pills() {
    codi.describe({ name: 'Pills test:', id: 'ui_elements_pills', parentId: 'ui_elements' }, () => {
         ...
         * @fucntion it
         */
        codi.it({ name: 'Should create pills', parentId: 'ui_elements_pills' }, () => {
         ...
         * @function it
         */
        codi.it({ name: 'We should be able to add pills', parentId: 'ui_elements_pills' }, () => {
         ...
         * @function it 
         */
        codi.it({ name: 'We should be able to remove pills', parentId: 'ui_elements_pills' }, () => {
