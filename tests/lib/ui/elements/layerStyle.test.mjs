...
export function layerStyleTest(mapview) {
    codi.describe({ name: 'LayerStyle test:', id: 'ui_elements_layer_style', parentId: 'ui_elements' }, async () => {
        ...
        //Hover checkbox 
        codi.it({ name: 'The panel function should return a hover check box', parentId: 'ui_elements_layer_style' }, () => {
        ...
        //hovers dropdown
        codi.it({ name: 'The panel function should return a hovers dropdown', parentId: 'ui_elements_layer_style' }, () => {
        ...
        //layer theme
        codi.it({ name: 'The panel function should return a layerTheme', parentId: 'ui_elements_layer_style' }, () => {
            const layerTheme = panel.querySelector('[data-id="layerTheme"]');
            codi.assertTrue(!!layerTheme, 'The panel should have a layerTheme');
        });

        //Themes dropdown
        codi.it({ name: 'The panel function should return a themes dropdown', parentId: 'ui_elements_layer_style' }, () => {
        ...
        codi.it({ name: 'The panel function should return an icon scaling field checkbox', parentId: 'ui_elements_layer_style' }, () => {
        ...
        //icon scaling slider
        codi.it({ name: 'The panel function should return an icon scaling slider', parentId: 'ui_elements_layer_style' }, () => {
        ...
        codi.it({ name: 'The panel function should return an icon scaling cluster slider', parentId: 'ui_elements_layer_style' }, () => {
        ...
        codi.it({ name: 'The panel function should return an icon scaling zoom in slider', parentId: 'ui_elements_layer_style' }, () => {
        ...
        codi.it({ name: 'The panel function should return an icon scaling zoom out slider', parentId: 'ui_elements_layer_style' }, () => {
