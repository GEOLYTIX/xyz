...
export function queryTest() {
    ...
    codi.describe({ name: 'Query: Testing Query API', id: 'api_query' }, () => {
         ...
         * @function it 
         */
        codi.it({ name: 'Testing Query defined on infoj entry', parentId: 'api_query' }, async () => {
         ...
         * @function it 
         */
        codi.it({ name: 'Testing Module defined in templates', parentId: 'api_query' }, async () => {
         ...
         * @function it 
         */
        codi.it({ name: 'Testing a query with a bogus dbs string via the req params', parentId: 'api_query' }, async () => {
            const expected_result = {
                'bar': 'foo'
            }
         ...
         * @function it 
         */
        codi.it({ name: 'Testing a query with a bogus dbs on the template', parentId: 'api_query' }, async () => {
