...
// The xyzEnv is resolved from the varlock environment in the processEnv module
// which overrides a WORKSPACE assigned to process.env. The resolved xyzEnv is
// frozen, so the argument is applied to a copy to take precedence over a
// WORKSPACE declared in the environment.
if (args.workspace) {
  globalThis.xyzEnv = Object.freeze({
    ...globalThis.xyzEnv,
