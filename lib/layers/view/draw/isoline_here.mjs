    ...
    <div
      ...
      <div style="grid-column: 2;">
        <button class="btn-drop">
          ...
          <ul>${modes.map(keyVal => _xyz.utils.html.node`
            <li onclick=${e => {
    ...
    <div
      ...
      <div style="grid-column: 2;">
        <button class="btn-drop">
          ...
          <ul>${ranges.map(keyVal => _xyz.utils.html.node`
            <li onclick=${ranges_li_onclick}>${Object.keys(keyVal)[0]}`)}`)

  function ranges_li_onclick(e) {
  ...
  function draw(e) {
    ...
    _xyz.mapview.interaction.draw.begin({
      ...
      geometryFunction: function (coordinates, geometry) {
        ...
        range = layer.edit.isoline_here.rangetype === 'time' ?
          (layer.edit.isoline_here.minutes || 10) * 60 : range
          
        range = layer.edit.isoline_here.rangetype === 'distance' ?
          (layer.edit.isoline_here.distance || 1) * 1000 : range

        xhr.open('GET', `${_xyz.host}/api/proxy?` +
