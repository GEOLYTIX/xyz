export default _xyz => layer => {
    ...
    <div
      ...
      <div
        ...
        <span>${layer.edit.isoline_here.headerText || _xyz.language.here_isoline_settings}</span>
    ...
    function draw(e) {
        ...
        _xyz.mapview.interaction.draw.begin({
            ...
            geometryFunction: function(coordinates, geometry) {
                ...
                _xyz
                  .xhr(`${_xyz.host}/api/proxy?url=${encodeURIComponent(`https://isoline.router.hereapi.com/v8/isolines?${_xyz.utils.paramString(params)}${
    ...
    function createElements(group) {
        ...
        let dateSelect = _xyz.utils.html.node `
        <input type="datetime-local"
        placeholder=${_xyz.language.layer_filter_pick}
        oninput=${e => {
            e.stopPropagation()
            if(!e.target.value) return
            layer.edit.isoline_here.dateISO = new Date(e.target.valueAsNumber).toISOString()
        }}
        >`
