export default _xyz => (layer, filter_entry) => {
  ...
  xhr.onload = e => {
    ...
    <div class="input-flex">
      <span>${_xyz.language.layer_filter_greater}`
    ...
    const div_min = _xyz.utils.html.node`<div class="input-range">`;
    block.appendChild(div_min);

    const slider_min = _xyz.utils.html.node`
    <input
      type="range"
    ...
    var range = _xyz.utils.html.node`
    <div class="input-flex">
      <span>${_xyz.language.layer_filter_smaller}`
    ...
    var div_max = _xyz.utils.html.node`<div class="input-range">`;
    block.appendChild(div_max);

    const slider_max = _xyz.utils.html.node`
    <input
      type="range"
      class="secondary-colour-bg"
      min=${field_range.min}
