export default _xyz => layer => {
  ...
  // theme.title && legend.appendChild(_xyz.utils.html.node`
  ...
  Object.entries(theme.cat).forEach(cat => {
    ...
    if (cat_style.svg || cat_style.type) {
      ...
      legend.appendChild(_xyz.utils.svg_symbols(Object.assign({legend: true}, cat_style)))
  ...
  if (theme.other) {
    ...
    if (layer.style.default.svg || layer.style.default.type) {
      ...
      legend.appendChild(_xyz.utils.svg_symbols(Object.assign({legend: true}, layer.style.default)))
    ...
    <div
      ...
      onclick=${e => {
        ...
        if (e.target.classList.contains('disabled')) {
          ...
          layer.filter.current[theme.field].in = Object.keys(theme.cat)
          
        } else {

          // Empty IN values filter array.
          delete layer.filter.current[theme.field].in
        }
  ...
  if (layer.style.cluster) {
    ...
    legend.appendChild(_xyz.utils.svg_symbols(Object.assign({legend: true, cluster: true}, layer.style.cluster)))
