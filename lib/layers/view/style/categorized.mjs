export default _xyz => layer => {
  ...
  if (layer.style.cluster) {
    ...
    legend.appendChild(_xyz.utils.html.node`
      <div style="position:relative; height: 40px; width: 40px;">
        ${symbol(Object.assign({}, layer.style.default, layer.style.cluster))}`)
  ...
  function symbol(params) {
    ...
    if (params.layers && Array.isArray(params.layers)) {
      return params.layers.map(_l => _xyz.utils.html`
        <img style="position:absolute; width: 100%; height: 100%" src="${_l.svg}"/>`)
    }
      
    return _xyz.utils.html`
      <img
        style="position:absolute; width: 100%; height: 100%"
        src="${params.svg || params.url || _xyz.utils.svg_symbols[params.type](params)}"/>`
