export default _xyz => layer => {
  ...
  const legend = _xyz.utils.html.node`<div>`

  layer.style.legend = legend

  layer.style.default && clusterStyle(layer, layer.style.default, 'Default')

  layer.style.cluster && clusterStyle(layer, layer.style.cluster, 'Cluster')

  layer.style.default && polyStyle(layer, layer.style.default, 'Polygon')

  layer.style.highlight && polyStyle(layer, layer.style.highlight, 'Highlight')

  return legend

  function polyStyle(layer, style, title){

    title && legend.appendChild(_xyz.utils.wire()`
  ...
  function clusterStyle(layer, style, title){
