export default _xyz => {
  ...
  function createGroup (layer){
    ...
    group.drawer = _xyz.layers.listview.node.appendChild(
      _xyz.utils.html.node`<div class="drawer layer-group expandable">`)

    // Create layer group header.
    const header = group.drawer.appendChild(_xyz.utils.html.node`
      <div
    ...
    const meta = group.drawer.appendChild(_xyz.utils.html.node`<div class="meta">`)
    ...
    group.addLayer = layer => {
      ...
      if (layer.groupmeta) {
        const metaContent = meta.appendChild(_xyz.utils.html.node`<div>`)
