...
// Assign the default 'en' dictionary to mapp.dictionaries.en
mapp.dictionaries.en = {
  "cancel": "Cancel",
  ...
  "pin": "Pin",
  "radius": "Radius",
  "remove_document_confirm": "Are you sure to remove this document? This cannot be undone.",
  "remove_image_confirm": "Are you sure to remove the image? This cannot be undone.",
  ...
  "user_locale_context": "Each project includes where your map is positioned, the layers that you see on the map and how they are styled.",
