...
async function upload(e, params) {
    ...
    if (uploaded.success === false) {
        mapp.ui.elements.alert({ title: mapp.dictionary.csv_upload_failed, text: uploaded.message });
        // Enable the view.
    ...
    // If the upload was successful, enable the view and alert the user that the data was imported successfully.
        ...
        view.classList.remove('disabled');
        mapp.ui.elements.alert({ title: mapp.dictionary.csv_upload_success, text: uploaded.message });
