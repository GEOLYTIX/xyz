...
export function keyvalue_dictionary(keyvalue_dictionary, mapview) {
  if (!mapview && keyvalue_dictionary.keyvalue_dictionary) {
    // The layer decorator will call the keyvalyue_dictionary plugin method with the layer as first argumnent if a keyvalue_dictionary is defined on the layer.
    parseObject(keyvalue_dictionary, keyvalue_dictionary.keyvalue_dictionary);
    return;
  }
