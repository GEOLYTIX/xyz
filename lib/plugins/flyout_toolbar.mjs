/**
 # /plugins/flyout_toolbar

 @module /plugins/flyout_toolbar
 ```json
 "flyout_toolbar": {
                "groups": {
                    "zoom": {
 ...
 */
/**
@function flyout_toolbar
@description
flyout_toolbar removes plugins from #mapButton container and places them in a new flyout toolbar 
where they are grouped according to plugin configuration based on data_id attribute of each element created by plugins.
*/
export async function flyout_toolbar(plugin, mapview) {
