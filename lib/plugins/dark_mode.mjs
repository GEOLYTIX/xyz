...
base-border - colour used for borders. Might be the same as any of background colours or contrasting for better readability.
...
changed - colour used as background on edited fields. Subtle yellow by default, should fit well with text for readability.
...
function toggleDarkMode(darkMode) {
  ...
  if (darkMode) {
    ...
    Object.entries(dark_palette).map((entry) => {
