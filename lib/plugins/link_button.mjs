...
@property {string} link.css_class The class for the div, defaults to "material-symbols-outlined primary-colour".
...
function addButton(link) {
  ...
  link.css_class ??= 'material-symbols-outlined primary-colour'

  link.icon_name ??= 'share'
