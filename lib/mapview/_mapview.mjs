...
export default (mapview) => {
  ...
  if (mapview.attribution) {
    ...
    mapview.attribution.check = () => {
      ...
      // mapview.attribution.target.append(mapp.utils.html.node`
      //   <a class="logo" target="_blank" style="height: 1.2em;" href="https://geolytix.co.uk">
