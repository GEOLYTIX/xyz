export default _xyz => layer => feature => {
  ...
  if (geometryType === 'Point') {
    ...
    }else if(layer.name === "Contributions" && style.type === "clusterSummary"){
  ...
  if (layer.highlight === feature.get('id')){
    ...
    if(layer.name === 'Custom' || layer.name === 'Custom 4258'){
      const fillColor = properties.highlightFillColor || highlightStyle.fillColor;
      const strokeColor = properties.highlightStrokeColor || highlightStyle.strokeColor;
