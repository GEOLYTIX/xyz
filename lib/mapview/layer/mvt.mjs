...
export default _xyz => layer => {
  ...
  function styleFn(feature) {
    ...
    function themeStyle(theme) {
      ...
      theme.type === 'basic' && theme.style && Object.assign(style, theme.style)
      ...
      // DB property.
      if (theme && theme.type === 'property') {
        feature.properties_ && _xyz.utils.merge(
          style,
          Object.entries(theme.properties).reduce((acc, [key, value]) => {
            const styleValue = feature.properties_[value]
