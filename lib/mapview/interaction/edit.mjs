export default _xyz => {
  ...
  function begin(params) {
    ...
    _xyz.mapview.interaction.edit.interaction = new ol.interaction.Modify({
      ...
      condition: e => {
        ...
        return !(_xyz.mapview.interaction.edit.trail && (_xyz.utils.turf.kinks.default(_xyz.utils.turf.flatten(_xyz.mapview.interaction.edit.trail).features[0]).features.length > 0));
  ...
  function validateFeature(e){
    ...
    if(_xyz.utils.turf.kinks.default(_xyz.mapview.interaction.edit.trail).features.length > 0){
