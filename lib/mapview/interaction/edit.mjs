export default _xyz => {
  ...
  function contextmenu(e) {
    ...
    !_xyz.mapview.interaction.edit.info && _xyz.mapview.interaction.edit.feature.length && menu.appendChild(_xyz.utils.wire()`<li class="off-white-hover" onclick=${_xyz.mapview.interaction.edit.update}>Update</li>`);
