  ...
  function pointerMove(e) {
    ...
    highlight.timeout = setTimeout(()=>{
      ...
      if (e.originalEvent.pointerType !== 'touch') {
        ...
        //   let style = highlight.feature.get('_style')

        //   console.log(style)

        //   const highlightStyle = _xyz.utils.cloneDeep(highlight.layer.style.highlight)

        //   if (highlight.feature.getGeometry().getType() === 'Point') {
        ...
        //   highlight.feature.setStyle(_xyz.utils.style(style))
