...
export default function (mapview) {
  ...
  if (typeof (mapview.interaction.snap) === 'string') {
    ...
    console.warn(`${mapview.interaction.layer.key} - snap: ${mapview.interaction.snap.layer} is not valid configuration. Use snap.layer: ${mapview.interaction.snap.layer}.`)
  }
