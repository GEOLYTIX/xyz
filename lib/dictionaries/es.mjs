export default {
  ...
  draw_dialog_begin_drawing:
    'Comenzar a dibujar - Haz clic en cualquier lugar del mapa',
  ...
  identical_values_filter:
    'Este campo contiene solo un valor distinto y no se puede filtrar.',
  image_upload_failed: 'Error al cargar la imagen.',
  information: 'Información',
  invalid_geometry: 'Geometría no válida',
  invalid_lat_lon:
    'Las coordenadas proporcionadas no caen dentro de la localidad seleccionada.',
  invalid_lat_long_range:
    'Coordenadas no válidas: los valores de latitud y longitud deben estar dentro de rangos válidos.',
  ...
  layer_filter_dropdown_select: 'Seleccionar múltiples',
  ...
  no_locales:
    'Su cuenta ha sido verificada y aprobada, pero no tiene acceso a ninguna localidad. Esto se debe probablemente a que un administrador no le ha asignado los roles necesarios. Por favor, contacte a un administrador para resolver este problema.',
