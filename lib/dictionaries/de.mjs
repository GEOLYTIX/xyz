export default {
  ...
  draw_dialog_remove_vertex:
    'Entferne letzten Scheitelpunkt - Rechte Maustaste',
  ...
  identical_values_filter:
    'Dieses Feld enthält nur einen eindeutigen Wert und kann nicht gefiltert werden.',
  ...
  layer_filter_dropdown_select: 'Mehrfachauswahl',
  ...
  no_locales:
    'Ihr Konto wurde verifiziert und genehmigt, aber Sie haben keinen Zugriff auf irgendwelche Bereiche. Dies liegt wahrscheinlich daran, dass ein Administrator Ihnen nicht die erforderlichen Rollen zugewiesen hat. Bitte wenden Sie sich an einen Administrator, um das Problem zu beheben.',
