export default {
  ...
  units: 'Units',
  user_locale_desc: 'My Views:',
  user_locale_specific:
    'Your saved views are personal and only visible to you. ',
  user_locale_context:
    'Saved views let you bookmark your current map setup - including zoom, layer visibility, and styling, so that you can easily return to them later. ',
  user_locale_save: 'Give your view a name and click the save icon to store it',
