...
export default _xyz => {
  ...
  return entry => {
      ...
      entry.container.appendChild(_xyz.utils.wire()`
        ...
        onchange=${e => {
          ...
          if (!entry.display && entry.edit) {
            ...
            if(entry.value && !confirm('Are you sure you want to delete additional geometry? This cannot be undone.')) return e.target.checked = true;
    ...
    if (!entry.value && entry.display) createGeom(e);
