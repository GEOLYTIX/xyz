export default _xyz => {
    ...
    function settings(entry) {
        ...
        if (entry.edit.isoline_here && !entry.edit.isoline_here.geometry && (entry.edit.isoline_here.minutes || (!entry.edit.isoline_here.minutes && entry.value))) return
    ...
    function create(entry) {
        ...
        xhr.open('GET', _xyz.host + '/api/provider/here?' +
            _xyz.utils.paramString({
                ...
                start: entry.edit.isoline_here.destination ? null : `geo!${origin.join(',')}`,
                destination: entry.edit.isoline_here.destination ? `geo!${origin.join(',')}` : null,
                range: range,
    ...
    <div
        ...
        <div></div><span>Use as destination`);
