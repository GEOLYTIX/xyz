export default _xyz => {
    ...
    function create(entry) {
        ...
        _xyz
            .proxy(`https://isoline.router.hereapi.com/v8/isolines?${_xyz.utils.paramString(params)}${
                entry.edit.isoline_here.maxPoints ? `&shape[${entry.edit.isoline_here.maxPoints}]` : ``
            }&{HERE}`)
            .then(response => {
    ...
    function panel(entry) {
        ...
        ><span>${entry.headerText || _xyz.language.here_isoline_settings}</span>
    ...
    function createElements(entry) {
        ...
        if (entry.edit.defaults.departureTime === undefined && entry.edit.defaults.arrivalTime === undefined) {
            ...
            oninput=${e => {
                ...
                entry.edit.isoline_here.dateISO = new Date(e.target.value).toISOString()
            }}
            >`;
