export default _xyz => {
  ...
  function create(entry) {
    ...
    const ll = ol.proj.toLonLat(entry.location.geometry.coordinates, 'EPSG:4326')

    _xyz
      .proxy(`https://api.tomtom.com/routing/1/calculateReachableRange/${ll[1]},${ll[0]}/json?${_xyz.utils.paramString(entry.edit.isoline_tomtom)}&\${TOMTOM}`)
      .then(response => {
