export default _xyz => {
    ...
    function settings(entry) {
        ...
        if (entry.edit.isoline_tomtom && entry.edit.isoline_tomtom.geometry && entry.edit.isoline_tomtom.timeBudgetInSec && !entry.value) return _xyz.utils.html.node `<div>`;
    ...
    function createElements(entry) {
        ...
        if (entry.edit.isoline_tomtom.departAt === undefined) {
