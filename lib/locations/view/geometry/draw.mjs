export default _xyz => {
	...
	function panel(entry){
        ...
        ><span>${entry.name ?  `${_xyz.language.layer_draw_edit} ${entry.name}` : _xyz.language.layer_draw_edit}</span>
    ...
    function polygon(entry){
    	...
    	entry.edit.group.polygon = _xyz.utils.html.node`
    		<div style="
          margin-top: 8px;
          grid-column: 1 / 3;
          display: grid;
          ...
          align-items: center;">
    		...
    		}}>${_xyz.language.layer_draw_polygon}`;
    ...
    function circle(entry){
    	...
    	if(entry.value) return _xyz.utils.html.node`<div>`;
    	...
    	entry.edit.group.circle = _xyz.utils.html.node`
    	<div style="
        margin-top: 8px;
        grid-column: 1 / 3;
        display: grid;
    	...
    	}}>${_xyz.language.layer_draw_circle}`;
    ...
    function rectangle(entry){
    	...
    	entry.edit.group.rectangle = _xyz.utils.html.node`
    	<div style="
        margin-top: 8px;
        grid-column: 1 / 3;
        display: grid;
    ...
    function freehand(entry){
    	...
    	entry.edit.group.freehand = _xyz.utils.html.node`
    	<div style="
        margin-top: 8px;
        grid-column: 1 / 3;
        display: grid;
    ...
    function line(entry){
    	...
    	entry.edit.group.line = _xyz.utils.html.node`
    	<div style="
        margin-top: 8px;
        grid-column: 1 / 3;
        display: grid;
    ...
    function edit(entry){
    	...
    	entry.edit.group.edit = _xyz.utils.html.node`
    	    <div style="
            margin-top: 8px;
            grid-column: 1 / 3;
            display: grid;
    	    ...
    	    onclick=${ e => {
    			...
    			_xyz.mapview.interaction.edit.begin({
    				...
    				type: typeof entry.value  === 'object' ? entry.value.type : JSON.parse(entry.value).type,
