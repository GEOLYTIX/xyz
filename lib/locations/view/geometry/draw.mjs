export default _xyz => {
    ...
    function rectangle(entry){
    	...
    	if(entry.edit.group.rectangle) return entry.edit.panel;
    ...
    function freehand(entry){
    	...
    	if(entry.edit.group.freehand) return entry.edit.panel;
    ...
    function line(entry){
    	...
    	if(entry.edit.group.line) return entry.edit.panel;
