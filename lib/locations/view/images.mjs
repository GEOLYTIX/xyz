export default _xyz => entry => {
  ...
  for (let image of entry.value) {
      ...
      <div
        class="${entry.class || ''}" style="position: relative; width: 120px; height: 120px; flex-grow: 1;">
  ...
  modalOverlay.appendChild(_xyz.utils.wire()`
    <span onclick=${
      e => {
    ...
    <input
      ...
      onchange=${e => {
        ...
        const placeholder = _xyz.utils.wire()`
          <div
          class="${entry.class || ''}" 
          style="position: relative; width: 120px; height: 120px; flex-grow: 1;"
          onclick=${
            e => {
