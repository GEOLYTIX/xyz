export default _xyz => entry => {
  ...
  let images_grid = _xyz.utils.wire()`
  <div class="images-grid" style="position: relative; display: flex; flex-wrap: wrap; grid-column: 1 / 3;"
  >`;
  ...
  for (let image of entry.value) {
      ...
      images_grid.appendChild(_xyz.utils.wire()`
      <div
        ...
        onclick=${ e => {
          ...
          console.log(entry.value.indexOf(e.target.src));
          document.querySelector('#modalOverlay img').src = e.target.src;
  ...
  document.getElementById('modalOverlay').appendChild(_xyz.utils.wire()`
    <span onclick=${
      e => {
  ...
  document.getElementById('modalOverlay').appendChild(_xyz.utils.wire()`<img style="padding-top: 40px;">`);
