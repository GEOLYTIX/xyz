export default _xyz => entry => {
  ...
  let images_grid = _xyz.utils.html.node`
    <div class="images-grid"
      style="position: relative; display: flex; flex-wrap: wrap; grid-column: 1 / 3; max-height: 400px; overflow-y: scroll;">`
      ...
      onchange=${e => {
        ...
        reader.onload = readerOnload => {
          ...
          img.onload = () => {
            ...
            xhr.open('POST', _xyz.host + '/api/provider/cloudinary?' + _xyz.utils.paramString({
            ...
            xhr.onload = e => {
              ...
              _xhr.open('GET', _xyz.host + '/api/query?' + _xyz.utils.paramString({
              ...
              _xhr.onload = _e => {
                ...
                if(document.getElementById('modalOverlay')) {
                  document.getElementById('modalOverlay').appendChild(_xyz.utils.html.node`
                    <div><img style="padding-top: 40px;" src=${secure_url}>`)
                }
  ...
  function removeDocument(e) {
    ...
    xhr.open('GET', _xyz.host + '/api/provider/cloudinary?' + _xyz.utils.paramString({
      destroy: true,
