          ...
          img.onload = () => {
            ...
            xhr.onload = e => {
              ...
              _xhr.onload = _e => {
                ...
                if(document.getElementById('modalOverlay')) document.getElementById('modalOverlay').appendChild(_xyz.utils.wire()`<div><img style="padding-top: 40px;" src=${secure_url}>`);
