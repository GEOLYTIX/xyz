export default _xyz => entry => {
  ...
  const _input = _xyz.utils.wire()`<input type="text" placeholder=${_xyz.language.layer_filter_pick} style="text-align: end;">${entry.type === 'datetime' && _xyz.utils.formatDateTime(entry.value) || _xyz.utils.formatDate(entry.value) || ''}`;
