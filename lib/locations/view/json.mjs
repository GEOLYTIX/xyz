export default _xyz => entry => {
    ...
    let span = _xyz.utils.html.node`<span style="display: none; font-size: smaller; color: red;">${_xyz.language.location_json_edit_msg}`;

    let content = JSON.stringify(entry.value, null, 2);

    let inner_div = entry.edit ? _xyz.utils.html.node`<pre><code><textarea 
    ...
    }}>${content}` : _xyz.utils.html.node`<pre><code>${content}`;
