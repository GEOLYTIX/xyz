export default _xyz => entry => {
  ...
  const src = `${_xyz.host}/api/proxy?uri=/maps/api/streetview?location=${lnglat[1]},${lnglat[0]}%26source=outdoor%26size=300x230&provider=GOOGLE&host=https://maps.googleapis.com`;
