...
### base-layout `#f0eee9`
The base layout colour serves the purpose of readability. It should be a hue to cut between secondary and tertiary background. It should be suitable for default font colour. It is used on content layout elements (eg. layer in layers list) that sit inside containers but also wrap inner containers. 
