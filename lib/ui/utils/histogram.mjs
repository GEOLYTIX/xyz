...
/**
  ...
  @property {String} params.options.xlabel - optional label for horizontal axis.
  */
...
/**
  ...
  @description
  The function sets new data and recreates the visual element.
  @param {Object} params Histogram configuration object.
  */
...
/**
  ...
  @param {Object} params Histogram configuration object.
  */
function createHistogram(params) {
  ...
  for (const bucket of params.data) {
    const style = `
