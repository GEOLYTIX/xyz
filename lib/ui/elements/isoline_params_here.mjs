...
export default (params) => {
  ...
  const modeDropDown = params.transportMode ? undefined : mapp.utils.html.node`
  ...
  const optimisedForDropDown = params.optimizeFor ? undefined : mapp.utils.html.node`
    <div style="display: grid; grid-template-columns: 100px 1fr; align-items: center;">
  ...
  let date_picker_label = params.dateISO === null ? undefined : mapp.utils.html.node`
    <span>${mapp.dictionary.here_datetime_depart}`

  let dateSelect = params.dateISO === null ? undefined : mapp.utils.html.node`
    <input
      type="datetime-local"
      onchange=${e => {
  ...
  const reverseDirectionChk = !params.reverseDirection ? undefined : mapp.ui.elements.chkbox({
