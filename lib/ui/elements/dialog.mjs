...
@property {Function} [dialog.close] A function called when the dialog is closed. The dialog element is closed and removed from DOM.
@property {boolean} [dialog.closeOnClick] Optional parameter to close the dialog when backdrop or the dialog itself is clicked.
...
export default function dialog(dialog) {
  ...
  dialog.closeBtn ??= mapp.utils.html.node`
    <button
      data-id=close
