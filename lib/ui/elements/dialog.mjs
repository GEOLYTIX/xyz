 ...
 * @param {string} [dialog.data_id='dialog'] - The data-id attribute value for the dialog.
 ...
 * @param {boolean} [dialog.modal] - A flag to determine if its a Modal or Dialog.
 * @param {Function} [dialog.close] - A function to be called when the dialog is closed.
 * @param {number} [dialog.top] - The top position of the dialog.
 * @param {number} [dialog.left] - The left position of the dialog.
 * @param {number} [dialog.right] - The right position of the dialog (used to calculate left position).
 * @param {boolean} [dialog.contained] - A flag indicating whether to keep the dialog within the target element's boundaries.
 * @param {boolean} [dialog.containedCentre] - A flag indicating whether to keep the dialog centered within the target element's boundaries.
 */
