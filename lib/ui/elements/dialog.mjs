...
@property {boolean} [dialog.hideCloseBtn] A flag to skip close button creation in the top right corner. Close button created by default.
...
export default function dialog(dialog) {
  ...
  dialog.closeBtn ??= dialog.hideCloseBtn ? `` : mapp.utils.html.node`
    <button
      data-id=close
