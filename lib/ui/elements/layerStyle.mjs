...
@property {Array<String>} [icon_scaling.fields] An array of fields which can be assigned the feature property for scaling.
...
function icon_scaling(layer) {
  ...
  if (layer.style.icon_scaling.field && layer.style.icon_scaling.fields) {
    console.warn(
      `Icon scaling: please only provide field or fields. fields has been removed`,
    );
    delete layer.style.icon_scaling.fields;
  }
  ...
  if (layer.style.icon_scaling.fields) {
    ...
    content.push(
      ...
      mapp.ui.elements.dropdown({
        ...
        callback: (e, options) => {
          if (options.option) {
            layer.style.icon_scaling.field = options.option;
          } else {
            delete layer.style.icon_scaling.field;
          }
        ...
        placeholder: layer.style.icon_scaling.placeholder,
      }),
    );
  }
