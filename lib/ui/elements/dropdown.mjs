...
The module creates a dropdown UI element - an expandable list of options to choose. 
Dropdown supports single or multiple selection.
Selected option or options can appear in the dropdown text or within a `pills` component.
...
@property {boolean} [params.mutli] Set `multi: true` in order to allow multiple choice.
...
export default (params) => {
  ...
  const headerSpan = params.keepPlaceholder ? params.placeholder : params.selectedTitles.size
