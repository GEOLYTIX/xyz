export default (params) => {
  ...
  function shiftEvent(e) {
    ...
    const isOutsideHorizontalBounds = modalCenterX < targetBounds.left || modalCenterX > targetBounds.right;
    const isOutsideVerticalBounds = modalCenterY < targetBounds.top || modalCenterY > targetBounds.bottom;
