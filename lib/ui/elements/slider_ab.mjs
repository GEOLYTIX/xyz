export default params => {
  ...
  function onInput(e) {
    ...
    if(params.entry.type !== 'integer' && stringValue.substring(stringValue.indexOf(params.separators.decimals), stringValue.length) === params.separators.decimals) return
    ...
    if(params.min || params.max){
      value < params.min && e.target.classList.add('invalid')
      value > params.max && e.target.classList.add('invalid')
    }
