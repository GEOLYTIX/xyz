export default params => {
  ...
  function onInput(e) {
    ...
    const numericValue = Number(e.target.value) || mapp.utils.numericFormatter(params.entry,e.target.value,true)
    ...
    element.querySelectorAll('input')
      .forEach(el => {
        ...
        if(e.target.type === 'text' && el.type === 'range'){
          ...
          el.value = mapp.utils.numericFormatter(params.entry,e.target.value)
        }
        if(el.dataset.id === 'a'){
