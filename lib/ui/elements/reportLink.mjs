...
export default function reportLink(params) {
  ...
  // Flag to indicate if the report should be opened in a dialog, only if not on mobile.
  const useDialog = params.report?.dialog && !mapp.utils.mobile();
