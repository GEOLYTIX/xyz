...
export default function numericInput(params) {
  ...
  if(params.formatter) {
    ...
    const displayValue = mapp.utils.html.node`<div class="val" 
    style="position: absolute; top: 0; left: 0; width: 100%; text-align: right; pointer-events: none;"
    >${formatValue(numericInput.value)}`
