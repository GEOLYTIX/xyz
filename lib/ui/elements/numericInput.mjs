...
@property {string} [params.data_id] - id for identification of the element.
@property {numeric} params.value - value currently held in the entry.
@property {numeric} [params.min] - a minimum value for the entry.
@property {numeric} [params.max] - a desired maximum for the entry.
@property {numeric} [params.step] - for range editing, the steps to increment in.
@property {numeric} [params.maxlength] - Maximum length of the number.
@property {function} [params.callback] - callback function
@property {string} [params.placeholder] - placeholder text on blank input.
