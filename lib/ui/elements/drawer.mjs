...
@property {string} params.classList Custom css classes, formatted as classList string.
@property {string} params.class Custom css classes, formatted as classList string. Optional parameter to include in the default classList value.
...
export default function drawer(params) {
  ...
  params.classList ??= `drawer expandable ${params.class || ''}`;
