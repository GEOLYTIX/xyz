...
export default function drawer(params) {
  ...
  const caret = params.header?.template?.find?.((el) => el.includes('caret'))
    ? ''
    : mapp.utils.html`
...
@description
The method create a return a button to toggle a dialog element.

The dialog will be closed when an associated header header is hidden.

With the showOnLayerDisplay dialog property flag the dialog will be shown when the layer is displayed.

@param {object} params
@property {layer} params.layer MAPP Layer associated with the dialog.
@property {string} params.data_id data_id for the dialog element.
@property {object} params.dialog Configuration for the dialog element.
@property {string} [dialog.btn_label="Open dialog"] Text for the button element returned from method.
@property {string} [dialog.btn_title="Open dialog"] Text for the button element title returned from method.
@property {boolean} [dialog.showOnLayerDisplay] The dialog should be shown when the layer is shown.
@property {string} [dialog.icon] Icon code for the button element.

@returns {HTMLElement} Button element to toggle the dialog.
*/
function drawerDialog(params) {
...
@description
The method will create and show a dialog element for the drawer content or show a dialog which has already been created.

@param {object} params
@property {layer} params.layer MAPP Layer associated with the dialog.
@property {string} params.data_id data_id for the dialog element.
@property {object} params.dialog Configuration for the dialog element.
@property {string} [dialog.title="Dialog"] Text for the dialog header.
@property {HTMLElement} dialog.btn Button element to toggle the dialog display.
@property {HTMLElement} dialog.content The dialog content.
*/
