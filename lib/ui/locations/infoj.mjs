...
@description
Adds a "question mark" symbol to indicate available information.
Symbol will be added to label tag or to a div.label container if either is found in the entry node.
