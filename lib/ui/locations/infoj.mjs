...
Specifying `entry.groupDrawer: false` in any of the entries of the group will prevent a drawer from being made for the group.
  ...
  if (!groups[entry.group]) {
    const groupDrawer =
      entry.location.infoj
        ...
        .find((e) => e.groupDrawer === false)?.groupDrawer ?? true;

    let drawer;
    if (groupDrawer === false) {
