...
Appends a list of the selected locations to the provided target.
...
export default function listview(params) {
  ...
  const record_scale = params.mapview.locale?.pin_scale || 3
  ...
  params.mapview.locations = new Proxy(params.mapview.locations, {
    set: function (location) {
      ...
      const icon = {
        ...
        scale: record.scale || record_scale,
        anchor: [0.5, 1]
      }
