...
@property {object} svg_templates A list of tyemplates to be cached and used with {@link module:/utils/svgSymbols}
...
export default function listview(params) {
  ...
  */
  function setRecord(target, key, location) {
    ...
    !record.colour && console.warn('listview: Custom listview record supplied with no colour, defaulting to `#fff`')
    location.style = {
      strokeColor: record.colour || '#fff',
      fillColor: record.colour || '#fff',
      fillOpacity: 0.1
    };
