...
export default function pin(entry) {
  ...
  entry.display ??= entry.display === undefined ? true : false;
...
function getExtent() {
  ...
  entry.buffer = parseInt(entry.buffer) || 200;

  return ol.extent.buffer(entry.L.getSource().getExtent(), entry.buffer);
}
