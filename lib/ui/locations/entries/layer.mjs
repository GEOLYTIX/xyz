...
@description
The featureLookup method attempts to populate featureLookup array from the entry.query.
*/
async function featureLookup(entry) {

  if (!entry.featureLookup) return;
