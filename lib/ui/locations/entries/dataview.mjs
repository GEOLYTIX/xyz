...
export default function dataview(entry) {
  ...
  // If entry.tabview classList contains 'mobile-display-none' then add to entry.chkbox.
  // So that the checkbox cannot be pressed when the tabview that shows the dataview is hidden.
  entry?.tabview?.classList.contains('mobile-display-none') && entry.chkbox.classList.add('mobile-display-none');
