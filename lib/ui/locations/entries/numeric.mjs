    ...
    return mapp.ui.elements.slider({
      ...
      callback: e => {
        ...
        if(e.target.type === 'text'){
          let formattedValue = mapp.utils.numericFormatter({...entry,...{value: e.target.value}})
          e.target.value = formattedValue ? formattedValue.replace(entry.suffix,'').replace(entry.prefix,'') : e.target.value
        }
      }
    });
  }
