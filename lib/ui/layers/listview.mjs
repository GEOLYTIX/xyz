...
Specifying `groupDrawer: false` in any of the members of the group will prevent the creation of a drawer for the group.
...
function createGroup(layer) {
  ...
  group.groupDrawer ??=
    Object.entries(layer.mapview.layers)
      ...
      .find((key) => key[1].groupDrawer === false)?.[1]?.groupDrawer ?? true;
