...
export default (layer) => {
  ...
  layer.mapview.Map.getTargetElement().addEventListener('changeEnd', () => {
    ...
    if (!layer.tableCurrent()) {
      ...
      // Show the zoomBtn if layer is out of zoomDisplay range.
      layer.zoomBtn.style.visibility = 'visible'
      ...
      // Don't show zoomBtn if layer is in zoomDisplay range.
      layer.zoomBtn.style.visibility = 'hidden'
