export default {
  ...
  filterAdd: filterAdd,
  catToggle: catToggle,
  distributedLegend: distributedLegend,
 ...
 * @description This function hides the distribution count theme on load. It also adds showCallbacks and hideCallbacks to hide the legend.
 * @param layer The layer the theme exists on.
 **/
function distributedLegend(layer) {
