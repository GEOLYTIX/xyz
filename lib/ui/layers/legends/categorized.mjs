export default (layer) => {
  ...
  */
  ...
  legendOptions?.alignContents == "center" && contentsClass.push["centered"];

  legendOptions?.alignContents == "row" && contentsClass.push["row"];
  ...
  layer.style.legend = mapp.utils.html.node`<div class=${`contents-wrapper ${legendOptions?.layout}`}>${grid}`
