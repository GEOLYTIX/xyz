export default (layer, displayOptions) => {
  /**
  * Creates a map legend for the given map layer
  * @param {Object} layer - Map layer the legend is for
  * @param {Object} displayOptions - Options for how the legend will be displayed
  * @param {string} displayOptions.type - Container display type, "grid" or "flex"
  * @param {string} displayOptions.alignContents - How the contents are aligned, "left" or "center"
  */
  ...
  let contentsClass = "contents";
  contentsClass += (displayOptions?.alignContents == "center" && displayOptions?.type == "flex") ? " centered" : "";
  contentsClass += (displayOptions?.alignContents == "row" && displayOptions?.type == "flex") ? " row" : "";
  ...
  layer.style.legend = mapp.utils.html.node`<div class=${`grid ${displayOptions?.type == "flex" && 'flex'}`}>${grid}`
