...
- multi_filter_title
- multi_filter_btn_label
- multi_filter_btn_title
- multi_filter_count
- multi_filter_layer_name
- multi_filter_in_viewport
- multi_filter_not_in_viewport
...
async function updateCount(layer) {
  ...
  if (!Object.keys(layer.filter?.current).length) {
    ...
    //Only hide the viewport description on the dialog
    layer.filter.dialog &&
  ...
  //Only display the viewport description on the dialog
  layer.filter.dialog &&
