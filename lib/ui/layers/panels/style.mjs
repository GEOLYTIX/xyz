...
mapp.utils.merge(mapp.dictionaries, {
  ...
  pl: {
    ...
    layer_style_switch_caption:
      'Kliknij na etykietę aby włączyć widzialność lub',
  ...
  esp: {
    ...
    layer_style_switch_caption:
      'Clic en las etiquetas para cambiar la visibilidad o',
  ...
  tr: {
    ...
    layer_style_switch_caption:
      'Gorunurlugu degistirmek icin etikete tiklayiniz veya',
  ...
  it: {
    ...
    layer_style_switch_caption:
      'Clicca sull etichetta per cambiare viibilità o',
    layer_style_switch_all: 'Cambiare tutto',
    layer_grid_legend_ratio:
      'Visualizza il colore proporzionale alla dimensione',
