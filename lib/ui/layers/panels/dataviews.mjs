...
export default function dataviews(layer) {
  ...
  for (const [key, dataview] of Object.entries(layer.dataviews)) {
    ...
    Object.assign(dataview, {
      key, layer, host: layer.mapview.host
    })
    ...
    if (dataview.tabview) {
      ...
      dataview.show ??= () => {
        ...
        dataview.tabview.dispatchEvent(new CustomEvent(
          'addTab', { detail: dataview }))
    ...
    if (mapp.ui.Dataview(dataview) instanceof Error) continue;
