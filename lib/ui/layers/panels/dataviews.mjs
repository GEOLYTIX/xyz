...
export default function dataviews(layer) {
  ...
  if (layer.dataviews.dialog) {
    layer.dataviews.dialog = {
      btn_label: 'Open Dataviews Dialog',
      title: 'Dataviews',
      icon: 'table_view',
      ...layer.dataviews.dialog,
    };
