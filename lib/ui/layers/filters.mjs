...
@returns {layer} The layer argument is returned To allow for functional compostion of itself.
*/
...
async function histogram(filter, layer) {
  ...
  layer.mapview.Map.getTargetElement().addEventListener('changeEnd', changeEnd);

  filter.histogram.removeChangeEnd = () => {

    layer.mapview.Map.getTargetElement().removeEventListener('changeEnd', changeEnd);
  }
