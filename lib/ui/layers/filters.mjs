...
function reloadCallback(layer) {
  ...
  // If the object has a zoomToFilteredExtentBtn and the filter.current object has a length greater than 0, show the zoomToFilteredExtentBtn.
  if (Object.keys(layer.filter.current).length>0) {
    layer.zoomToFilteredExtentBtn.style.setProperty('display','block')
  } else {
