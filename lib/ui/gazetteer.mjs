      ...
      Object.values(e.target.response).forEach(entry => {
        ...
        gazetteer.result.append(mapp.utils.html.node`
          <li
            ...
            <span class="label">${(gazetteer.mapview.layers[entry.layer] && gazetteer.mapview.layers[entry.layer].name) || entry.layer || entry.source}</span>
