...
export default async function Dataview(_this) {
  ...
  _this.show ??= displayDataview

  _this.hide ??= hideDataview
...
@description
The hideDataview method will remove the dataview tab if in a tabview. The remove() method only available for tabs will be called.
