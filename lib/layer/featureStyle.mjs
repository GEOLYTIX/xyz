...
The property values of feature in a cluster are summed up. The avgCluster flag can be set to average cluster feature property values.
...
@property {boolean} [icon_scaling.avgCluster] Calculate an average of cluster feature property values.
*/
function iconScale(feature, layer) {
  ...
  layer.style.icon_scaling.maxFactor ??= 100
  ...
  if (feature.properties.features?.length > 1) {
    ...
    if (layer.style.icon_scaling.avgCluster) {
