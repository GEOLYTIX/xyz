...
@property {layer-style} layer.style The JSON layer style configuration.
...
export default layer => {
  ...
  return function Style(feature) {
    ...
    // Features with their ID in a layer.featureSet will not be styled.
    if (layer.featureSet) {

      const id = feature.get('id').toString()

      if (!layer.featureSet.has(id)) return null;
    }
