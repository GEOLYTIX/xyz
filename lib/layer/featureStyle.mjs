...
The scale [size] of icons based on their property values should always increase. The scale is therefore calculated as fraction of the property value divided by the scaleFactor. A property value of 50 [%] with a scaleFactor of 100 [default] would add a fracyion of .5 to 1 to ensure that the icon scale is increased by multiplying the scale by 1.5. The icon_scaling.max calculated in the featureFields process method will be used as scaleFactor if not implicit.
...
@property {numeric} [icon_scaling.scaleFactor] Scaling is a fraction of the field value divided by the scaleFactor.
...
function iconScale(feature, layer) {
  ...
  const factor = layer.style.icon_scaling.scaleFactor || layer.style.icon_scaling.max || 1
