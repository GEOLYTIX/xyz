...
The vector format function assigns an Openlayers vector layer [.L] and it's source to the layer object along with methods to reload() and setFeatures().

@function layer/formats/vector
@memberof module:layer/formats
