...
export default layer => {
  ...
  if (layer.properties) {
    console.warn(`layer.properties{} are no longer required for geojson datasets.`)
  }
  ...
  layer.loadFeatures(layer.features)
