 ...
 * 
 * @function layer/decorate
 * @memberof module:_layer
 * @author @dbauszus-glx
 * @param {Object} layer - The layer object to be decorated.
 * @returns {Promise<Object>} - A promise that resolves with the decorated layer object.
 */
