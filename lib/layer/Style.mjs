export default layer => feature => {
  ...
  feature.style =  Object.assign({}, layer.style.default)
  ...
  // Assign theme style
  layer.style.theme?.style && Object.assign(feature.style, layer.style.theme?.style)
  ...
  if (layer.mapview?.locations[`${layer.key}!${feature.properties.id}`] && layer.style.selected) {
