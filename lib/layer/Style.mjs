export default layer => feature => {
  ...
  if (layer.style.label?.display) {
    ...
    if (feature.properties[feature.style.label.field] === 0) {
      console.log(feature.properties)
      console.log(typeof feature.properties[feature.style.label.field])
    }

    // Assign count value as text if label.count is truthy.
    feature.style.label.text = feature.style.label.count && feature.properties.count > 1 && feature.properties.count
