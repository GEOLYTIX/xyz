...
export default layer => {
  ...
  function clusterChecks(layer) {
    ...
    const nonIconKeys = Object.keys(layer.style.default).filter(key => key !== 'icon');

    if (nonIconKeys.length > 0) {

      console.warn(`Cluster Layer: ${layer.key}; none icon keys : ${nonIconKeys} will be removed from default style`)
