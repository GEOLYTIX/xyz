...
export async function getInfoj(location) {
  ...
  // Check if the response is an array.
    ...
    console.warn(`Location response returned more than one record for Layer: ${location.layer.key}, Table: ${location.table}, ID: ${location.layer.id}. This is not allowed.`)
    return
  }
