...
async function syncFields(fields) {
  ...
  // If the response is an array, warn and return.
  if (Array.isArray(response)) {
    console.warn(`Location response returned more than one record for Layer: ${this.layer.key}, Table: ${this.table}, ID: ${this.id}. This is not allowed.`)
    return
  }
