...
Removes the location object from it's [layer] mapview.locations list.

@property {method} update()
Update the location's entry fields with their respective newValues at rest.

@property {method} syncFields(fields)
Sync the location's entry field values from rest.
*/
