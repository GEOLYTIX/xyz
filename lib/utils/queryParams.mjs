...
```
The queryParams method is particularely useful for calculating the current [viewport] bounds for a data query and to determine the current table for the mapviews current zoom level.
...
@property {layer} [_this.layer] The layer associated with _this object.
