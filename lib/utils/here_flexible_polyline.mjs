...
export function decodeUnsignedValues(encoded) {
    let result = Num(0);
    let shift = Num(0);
    const resList = [];
...
export function decodeHeader(version, encodedHeader) {
...
export function encodeHeader(precision, thirdDim, thirdDimPrecision) {
...
export function encodeUnsignedNumber(val) {
...
export function encodeScaledValue(value) {
