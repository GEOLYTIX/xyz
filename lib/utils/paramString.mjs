...
This module exports the paramString method as default.
...
The function takes a params object and returns a URL parameter string.
...
function paramString(params) {
  ...
  // Return empty string for falsy params param.
  if (!params) return ''
  ...
  const paramsString = Object.entries(params)
    ...
    // Map params properties which pass all filter.
    .map(entry => {

      // Encapsulate a fields array in braces.
