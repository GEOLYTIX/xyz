    ...
    return new Promise((resolve, reject) => {
        ...
        reader.onload = (e) => {
            ...
            if (
                ...
                outcome.message =`${mapp.dictionary.number_of_columns_imported} (${headers.length})
            ...
            Promise.all(promises).then(async (responses) => {
                ...
                responses.forEach(element => {
                    if (element instanceof Error) {
                        ...
                        // This provides the calling function with a message to display to the user, about why the import failed.
                        outcome.success = false;
                        outcome.message =`${mapp.dictionary.import_failed}`;
                ...
                outcome.message =`${mapp.dictionary.import_successful} ${rows.length} ${mapp.dictionary.rows_imported}`;
                resolve(outcome); 
            }).catch(error => {
                outcome.success = false;
