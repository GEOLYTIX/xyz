...
// Define type methods.
// These are used to convert the field values to the correct type for the database.
// The methods are used in the chunkRows method to convert the field values to the correct type for the database.
// This escapes single quotes in the text fields to prevent issues with insertion, and will remove non-numeric characters from the int and numeric fields.
const schemaMethods = {
