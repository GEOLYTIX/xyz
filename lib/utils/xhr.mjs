...
@description
A request will be debounced if the params.debounce property is falsy [undefined].
...
@returns {booolean} true if request will be debounced.
*/
...
function debounce(xhr, params, reject) {
  ...
  // This request will be deboounced.
  return true;
}
