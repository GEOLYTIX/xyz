...
function dot(style) {
  ...
  <svg width=24 height=24 viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
    <circle cx=11 cy=10.5 r=10 fill='#333'></circle>
...
function triangle(style) {
  ...
  const icon = svg.node`
  <svg width=32 height=24 viewBox='-2 -2 22 24' xmlns='http://www.w3.org/2000/svg'>
...
function markerLetter(style) {
  ...
  <svg width=24 height=24 viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
    ...
    <path fill=${style.color}
      d=" M 11.966 1.969 C 7.878 1.969 4.813 5.239 4.813 9.328 C 4.813 10.554 5.222 12.189 6.244 14.028 C 8.289 17.504 11.966 22 11.966 22 C 11.966 22 16.055 17.504 18.099 14.028 C 19.122 12.189 19.341 10.963 19.341 9.328 C 19.341 5.239 16.054 1.969 11.966 1.969 Z "/>
