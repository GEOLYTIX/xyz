...
function clusterSummary(style) {
  ...
  const { count, cat } = style.properties;
  let size;
  if (count <= 100) size = 15;
  else if (count <= 500) size = 18;
  else if (count <= 1000) size = 20;
  else size = 25;
