...
function triangle(style) {
    ...
    const icon = svg.node`<svg width=24 height=24 viewBox='${`0 0 24 24`}' xmlns='http://www.w3.org/2000/svg'>`

    icon.appendChild(svg.node `<polygon
    fill=${style.fillColor || '#FFF'} stroke=${style.fillColor || '#FFF'} stroke-width=2
    points="12,4.68 3,22 22,22"  stroke-linejoin="round"/>`)
...
function square(style) {
    ...
    const icon = svg.node `
  <svg width=24 height=24 viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
    <rect fill=${style.fillColor || '#FFF'} width=20 height=20 x=2 y=0 rx=1></rect>`
