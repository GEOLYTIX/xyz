  ...
  function search (term, params = {}){
    ...
    gazetteer.xhr.onload = e => {
      ...
      Object.values(e.target.response).forEach(entry => {
        ...
        gazetteer.result.appendChild(_xyz.utils.wire()`
        <li style="cursor:pointer; position: relative; onclick=${e=>{
          e.preventDefault();
        ...
        <span class="secondary-colour-bg" style="font-size: smaller; position: absolute; top: 5px; right: 5px; padding: 3px; cursor: help; border-radius: 2px;">${entry.layer || entry.source}`);
