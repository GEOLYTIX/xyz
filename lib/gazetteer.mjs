export default _xyz => {
  ...
  function search (term, params = {}){
    ...
    gazetteer.xhr.onload = e => {
      ...
      Object.values(e.target.response).forEach(entry => {
        ...
        ${_xyz.locale.gazetteer.label ? _xyz.utils.wire()`
  ...
  function google(record) {
    ...
    xhr.open('GET', `${_xyz.host}/api/proxy?uri=/maps/api/place/details/json?placeid=${record.id}&provider=GOOGLE&host=https://maps.googleapis.com`);
