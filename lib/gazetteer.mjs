  ...
  function search (term, params = {}){
    ...
    gazetteer.xhr.onload = e => {
      ...
      Object.values(e.target.response).forEach(entry => {
        ...
        gazetteer.result.appendChild(_xyz.utils.wire()`
        <li style="cursor:pointer; position: relative; height: 22px;" onclick=${e=>{
          e.preventDefault();
        ...
        <span style="position: absolute;">${entry.label}</span>
        <span class="secondary-colour-bg" style="font-size: smaller; position: absolute; top: 5px; right: 5px; padding: 2px; cursor: help; border-radius: 2px;">${entry.layer || entry.source}`);
