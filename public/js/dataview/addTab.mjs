export default _xyz => table => {
  ...
  <li
   ...
   let count1 = _xyz.dataview.nav_bar.children.length || 0,
  ...
  _xyz.dataview.nav_dropdown_btn.style.display = _xyz.dataview.nav_dropdown.children.length > 0 ? 'inline-flex' : 'none';
