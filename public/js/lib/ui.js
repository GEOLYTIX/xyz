mapp.utils.merge(mapp.dictionaries,{en:{layer_zoom_to_extent:"Zoom to filtered layer extent",layer_visibility:"Toggle visibility"},de:{layer_zoom_to_extent:"Zoom zum Ausma\xDF des gefilterten Datensatzes",layer_visibility:"Umschalten der Ansicht"},cn:{layer_zoom_to_extent:"\u7F29\u653E\u81F3\u76F8\u5E94\u7B5B\u9009\u8303\u56F4",layer_visibility:"\u5207\u6362\u53EF\u89C1\u6027"},pl:{layer_zoom_to_extent:"Poka\u017C zasi\u0119g warstwy",layer_visibility:"Widoczno\u015B\u0107"},ko:{layer_zoom_to_extent:"\uD544\uD130\uB41C \uB808\uC774\uC5B4\uD06C\uAE30\uC5D0 \uC90C(zoom)",layer_visibility:"\uD1A0\uAE00 \uAC00\uC2DC\uC131"},fr:{layer_zoom_to_extent:"Zoom sur l'\xE9tendue de la couche",layer_visibility:"Changer la visiblit\xE9"},ja:{layer_zoom_to_extent:"\u30D5\u30A3\u30EB\u30BF\u30FC\u3055\u308C\u305F\u30EC\u30A4\u30E4\u30FC\u7BC4\u56F2\u3092\u30BA\u30FC\u30E0\u306B",layer_visibility:"\u8868\u793A\u5207\u66FF"}});var _=e=>{let t=e.filter.zoomToExtent&&mapp.utils.html`
  ...
  <div class="dropdown active">
    ...
    <ul></ul>`;return mapp.ui.Gazetteer(Object.assign({mapview:e.mapview,target:t,layer:e.key},e.gazetteer)),t};mapp.utils.merge(mapp.dictionaries,{en:{layer_dataview_header:"Data Views"},de:{layer_dataview_header:"Datenansichten"},cn:{layer_dataview_header:"\u6570\u636E\u68C0\u89C6"},pl:{layer_dataview_header:"Widoki danych"},ko:{layer_dataview_header:"\uB370\uC774\uD130 \uBCF4\uAE30"},fr:{layer_dataview_header:"Vues des donn\xE9es"},ja:{layer_dataview_header:"\u30C7\u30FC\u30BF\u30D3\u30E5\u30FC"}});var V=e=>{let t=Object.entries(e.dataviews).map(a=>{if(typeof a[1]!="object")return;let i=Object.assign(a[1],{key:a[0],layer:e,host:e.mapview.host}),o=document.querySelector(`[data-id=${i.target}]`);if(!o)return;i.target=mapp.utils.html.node`<div class="dataview-target">`,e.display&&i.display&&n();function n(){if(i.show)return i.show();mapp.ui.Dataview(i).then(()=>i.show()),o.dispatchEvent(new CustomEvent("addTab",{detail:i}))}return e.showCallbacks.push(()=>{i.display&&n()}),mapp.ui.elements.chkbox({label:i.title||i.key,checked:!!i.display,onchange:r=>{i.display=r,i.display?n():i.remove()}})});return e.dataviews.hide?void 0:mapp.ui.elements.drawer({data_id:"dataviews-drawer",class:"raised",header:mapp.utils.html`
      ...
      <div class="mask-icon expander"></div>`,content:mapp.utils.html`${t}`})};var G=e=>{let t=Object.keys(e.reports).map(a=>{let i=e.reports[a];i.key=a,i.host=e.mapview.host;let o=`${i.host}/view?${mapp.utils.paramString({template:i.template,locale:e.mapview.locale.key,lat:mapp.hooks.current?.lat,lng:mapp.hooks.current?.lng,z:mapp.hooks.current?.z})}`;return mapp.utils.html`
      <a
        class="link-with-img"
        target="_blank"
        href="${o}">
    ...
    <div class="legend">
      ...
      <div class="mask-icon expander"></div>`,content:t}),e.style.drawer};var k=e=>{let t=e.style.theme,l=[];if(e.filter&&l.push(mapp.utils.html`
    <div
      class="switch-all"
      ...
      <div
        ...
        style="grid-column: 2;"
        onclick=${r=>{!e.filter||(r.target.classList.toggle("disabled"),r.target.classList.contains("disabled")?(e.filter.current[t.field]||(e.filter.current[t.field]={}),e.filter.current[t.field].ni||(e.filter.current[t.field].ni=[]),e.filter.current[t.field].ni.push(a[1].keys||a[0]),e.filter.current[t.field].ni=e.filter.current[t.field].ni.flat()):(Array.isArray(a[1].keys)?a[1].keys.forEach(s=>{e.filter.current[t.field].ni.splice(e.filter.current[t.field].ni.indexOf(s),1)}):e.filter.current[t.field].ni.splice(e.filter.current[t.field].ni.indexOf(a[0]),1),e.filter.current[t.field].ni.length||delete e.filter.current[t.field]),e.reload())}}>${a[1].label||a[0]}`;l.push(mapp.utils.html`
    <div 
      data-id=${a[0]}
      class="contents">
      ...
      <div 
        data-id="cluster"
        class="contents">
        ${a}${i}`)}return e.style.legend=mapp.utils.html.node`<div class="grid">${l}`,e.style.legend};var B=e=>(e.style.legend=mapp.utils.html.node`<div>`,e.style.legend);var x=e=>{let t=e.style.theme,l=[];return t.cat_arr.forEach(a=>{let i=Object.assign({},e.style.default,a.style&&a.style.icon||a.style||a),o=mapp.utils.html`
      <div
        style="height: 24px; width: 24px; grid-column: 1;">
        ${mapp.ui.elements.legendIcon(Object.assign({width:24,height:24},i))}`,n=mapp.utils.html`
      ...
      <div 
        data-id=${a.value}
        class="contents">
        ${o}${n}`)}),e.style.legend=mapp.utils.html.node`<div class="grid">${l}`,e.style.legend};var L=e=>{let t=[];t.push(mapp.ui.elements.dropdown({entries:Object.entries(e.grid_fields).map(o=>({title:o[0],options:o[1]})),callback:(o,n)=>{e.grid_size=n.options,e.reload()}}));let l=e.style.range.length,a=new XMLSerializer,i=mapp.utils.html`
  <div
    class="grid"
    ...
    <div data-id="size-icons" class="contents">
      ${e.style.range.map((o,n)=>{let r=mapp.utils.svg.node`<svg height=50 width=50>
          ...
          <circle
            ...
            cx=25
            cy=25
            r='${23/l*(n+1)}'/>`,s=`data:image/svg+xml,${encodeURIComponent(a.serializeToString(r))}`,d=`
          grid-row:2;
          grid-column:${n+1};
  ...
  <div
    ...
    <button 
      ...
      ${mapp.dictionary.location_clear_all}`);return e.mapview.locations=new Proxy(e.mapview.locations,{set:function(a,i,o){let n=W.find(r=>!r.hook);return n.hook=o.hook,o.record=n,o.style={strokeColor:n.colour,fillColor:n.colour,fillOpacity:.2},o.Style=mapp.utils.style([{strokeColor:"#000",strokeOpacity:.1,strokeWidth:8},{strokeColor:"#000",strokeOpacity:.1,strokeWidth:6},{strokeColor:"#000",strokeOpacity:.1,strokeWidth:4},{strokeColor:o.style.strokeColor||"#000",strokeWidth:2,fillColor:o.style.fillColor||o.style.strokeColor||"#fff",fillOpacity:o.style.fillOpacity||.2}]),o.pinStyle=mapp.utils.style({icon:{type:"markerLetter",letter:n.symbol,color:o.style.strokeColor,scale:3,anchor:[.5,1]}}),Reflect.set(...arguments),mapp.ui.locations.view(o),Object.values(t.node.children).forEach(r=>r.classList.remove("expanded")),t.node.insertBefore(o.view,l.nextSibling),o.view.dispatchEvent(new Event("addLocationView")),l.style.display="block",document.querySelector("[data-id=locations]").click(),document.querySelector("[data-id=locations]").style.display="block",!0},deleteProperty:function(a,i){Reflect.deleteProperty(...arguments);let o=W.find(n=>n.hook===i);return o&&delete o.hook,setTimeout(()=>{if(!document.querySelectorAll("#locations > .location-view").length){document.querySelector("[data-id=layers]").click(),l.style.display="none";let n=document.querySelector("#locations #gazetteerInput");n?n.value="":document.querySelector("[data-id=locations]").style.display="none"}},300),!0}}),t};var Z=(e,t)=>{if(!e.infoj)return;let l=mapp.utils.html.node`<div class="location-view-grid">`,a={};for(let i of t||e.infoj){if(e.view&&e.view.classList.contains("disabled"))break;if(i.listview=l,i.type=i.type||"text",i.objectAssignFromField){let n=i.location.infoj.find(r=>r.field===i.objectAssignFromField);n&&Object.assign(i,n.value)}if(i.objectMergeFromField){let n=i.location.infoj.find(r=>r.field===i.objectMergeFromField);n&&mapp.utils.merge(i,n.value)}if(i.skipEntry||i.skipFalsyValue&&!i.value&&!i.edit||i.skipUndefinedValue&&typeof i.value>"u"&&!i.edit||i.skipNullValue&&i.value===null&&!i.edit)continue;i.nullValue&&i.value===null&&!i.defaults&&!i.edit&&(i.value=i.nullValue),i.group&&(a[i.group]||(a[i.group]=i.listview.appendChild(mapp.ui.elements.drawer({class:`group ${i.expanded&&"expanded"||""}`,header:mapp.utils.html`
              <h3>${i.group}</h3>
    ...
    <div
      class="val"
      style="${`${e.css_val||""}`}">
      ${e.prefix}${l}${e.suffix}`,t};function at(e){let t=e.edit.options.find(i=>typeof i=="object"&&Object.values(i)[0]===e.value||i===e.value)||e.value;e.value=t&&typeof t=="object"&&Object.keys(t)[0]||t||e.value||" ";let l=e.edit.options.map(i=>({title:typeof i=="string"&&i||Object.keys(i)[0],option:typeof i=="string"&&i||Object.values(i)[0]}));return mapp.ui.elements.dropdown({span:e.value,entries:l,callback:(i,o)=>{e.newValue=o.option,e.location.view?.dispatchEvent(new CustomEvent("valChange",{detail:e}))}})}var z=e=>{e.query&&mapp.utils.xhr(`${e.location.layer.mapview.host}/api/query/${e.query}`).then(a=>{e.node.querySelector(".val").innerHTML=a[e.params.field]});let t=e.type!=="html"?e.value:"";e.edit&&(t=mapp.utils.html`
    <textarea
      style="auto; min-height: 50px;"
      onfocus=${a=>{a.target.style.height=a.target.scrollHeight+"px"}}
      onfocusout=${a=>{a.target.style.height="auto"}}
  ...
  <div 
    ...
    <button
      class="flat wide bold primary-colour"
      onclick=${a=>t(a,l)}>
      ${mapp.dictionary.draw_polygon}`}function ft(e,t){e.edit.circle=Object.assign({units:"meter",radius:100,tooltip:{metric:"distance"}},typeof e.edit.circle=="object"&&e.edit.circle||{});let l={meter:s=>s,km:s=>s*1e3,miles:s=>s*1609.34,meter2:s=>Math.sqrt(s/Math.PI),km2:s=>Math.sqrt(s*1e6/Math.PI)},a=mapp.utils.html.node`
    <div style="display: grid; grid-template-columns: 100px 1fr; align-items: center;">
      <div style="grid-column: 1;">Units</div>
      <div style="grid-column: 2;">
        ${mapp.ui.elements.dropdown({placeholder:e.edit.circle.units,entries:[{title:"Meter",option:"meter"},{title:"KM",option:"km"},{title:"Miles",option:"miles"},{title:"Meter\xB2",option:"meter2"},{title:"KM\xB2",option:"km2"}],callback:(s,d)=>{e.edit.circle.units=d.option}})}`,i=mapp.ui.elements.slider({label:"Radius",min:1,max:1e3,val:e.edit.circle.radius,callback:s=>{e.edit.circle.radius=parseInt(s.target.value)}}),o=mapp.utils.html.node`
    <button
      class="raised wide bold primary-colour"
      onclick=${s=>{let d=Object.assign({},e,{type:"Point",geometryFunction:c=>new ol.geom.Polygon.circular(ol.proj.toLonLat(c),l[e.edit.circle.units](e.edit.circle.radius),64).transform("EPSG:4326","EPSG:3857")});t(s,d)}}>Set Centre`,n=mapp.utils.html.node`
    <button
      class="raised wide bold primary-colour"
      onclick=${s=>{let d=Object.assign({},e,{type:"Circle",geometryFunction:ol.interaction.Draw.createRegularPolygon(33),tooltip:e.edit.circle.tooltip});t(s,d)}}>Manual Circle`;return mapp.ui.elements.drawer({header:mapp.utils.html`
      <h3>Circle</h3>
      <div class="mask-icon expander"></div>`,content:mapp.utils.html`<div class="panel flex-col">
      ${a}
      ${i}
      ${o}
      ${n}`})}function ht(e,t){let l=Object.assign({},e,{type:"Circle",geometryFunction:ol.interaction.Draw.createBox(),tooltip:e.edit.rectangle.tooltip});return mapp.utils.html.node`
    <button
      class="flat wide bold primary-colour"
      onclick=${a=>t(a,l)}>
      ${mapp.dictionary.draw_rectangle}`}function gt(e,t){let l=Object.assign({},e,{type:"Point",geometryFunction:n=>mapp.utils.here.geometryFunction(n,e.layer,i)});typeof l.edit.isoline_here!="object"&&(l.edit.isoline_here={});let a={"range[type]":"time",range:10,rangeMin:5,rangeMax:60,transportMode:"car",optimizeFor:"balanced"},i=Object.assign(l.edit.isoline_here,a),o=mapp.ui.elements.isoline_params_here(i);return o.append(mapp.utils.html.node`
    <button
      class="flat wide bold primary-colour"
      onclick=${n=>t(n,l)}>
  ...
  <button 
    ...
    <div style="display: grid; grid-template-columns: 100px 1fr; align-items: center;">
      ...
      <div style="grid-column: 2;">
        ${mapp.ui.elements.dropdown({entries:[{title:[mapp.dictionary.here_mode_driving],option:"car"},{title:[mapp.dictionary.here_mode_walking],option:"pedestrian"}],callback:(d,c)=>{e.transportMode=c.option}})}`,l=mapp.utils.html.node`
    <div style="display: grid; grid-template-columns: 100px 1fr; align-items: center;">
      <div style="grid-column: 1;">${mapp.dictionary.here_optimize_for}</div>
      <div style="grid-column: 2;">
        ${mapp.ui.elements.dropdown({entries:[{title:[mapp.dictionary.here_optimize_for_balanced],option:"balanced"},{title:[mapp.dictionary.here_optimize_for_quality],option:"quality"},{title:[mapp.dictionary.here_optimize_for_performance],option:"performance"}],callback:(d,c)=>{e.optimizeFor=c.option}})}`,a=mapp.utils.html.node`
    <span>${mapp.dictionary.here_datetime_depart}`,i=mapp.utils.html.node`
    <input
      type="datetime-local"
      onchange=${d=>{let c=s.querySelector("[data-id=reverse_direction] > input");d.target.value?(e.dateISO=new Date(d.target.value).toISOString(),c&&(e.reverseDirection=!1,c.checked=!1,c.disabled=!0)):(e.dateISO=void 0,c&&(c.disabled=!1))}}>`,o=mapp.utils.html.node`
    <div>
      ${a}
      ${i}`,n=mapp.ui.elements.slider({label:mapp.dictionary.here_range_minutes,min:e.rangeMin,max:e.rangeMax,val:10,callback:d=>{e.range=parseInt(d.target.value)}}),r=typeof e.reverseDirection<"u"&&mapp.ui.elements.chkbox({label:"Reverse Direction Isoline",data_id:"reverse_direction",checked:!!e.reverseDirection,onchange:d=>{a.textContent=d&&mapp.dictionary.here_datetime_arrive||mapp.dictionary.here_datetime_depart,e.reverseDirection=d}}),s=mapp.ui.elements.drawer({header:mapp.utils.html`
    ...
    <div 
      ...
      <div style="display: grid; grid-row-gap: 5px;">
        ${t}
        ${l}`})};var xe=new XMLSerializer,Le=e=>{if(e.svg||e.type||e.layers){let t=e.layers&&Array.isArray(e.layers)&&e.layers.map(a=>`url(${a.svg})`).reverse().join(",")||`url(${e.svg||e.url||mapp.utils.svgSymbols[e.type](e)})`,l=`
      background-position: center;
      background-repeat: no-repeat;
      background-size: contain;
      ...
      <svg height=${e.height} width=${e.width}>
        <path d=${t}
          ...
          stroke-width=${e.strokeWidth||1}/>`,a=`data:image/svg+xml,${encodeURIComponent(xe.serializeToString(l))}`,i=`
      background-position: center;
      background-repeat: no-repeat;
      background-size: contain;
      width: ${e.width}px;
      ...
      <svg height=${e.height} width=${e.width}>
        <rect
          ...
          stroke=${e.strokeColor}
          stroke-width=${e.strokeWidth||1}>`,l=`data:image/svg+xml,${encodeURIComponent(xe.serializeToString(t))}`,a=`
      background-position: center;
      background-repeat: no-repeat;
      background-size: contain;
      width: ${e.width}px;
      height: ${e.height}px;
      background-image: url(${l});`;return mapp.utils.html`<div style=${a}>`}};var Ee=e=>{if(!(e.target instanceof HTMLElement))return;e.modal=e.target.appendChild(mapp.utils.html.node`
    <div 
    ...
    <div
      ...
      <input id="a"
        ...
        value=${e.val}
        step=${e.step||1}
        oninput=${t}>`;function t(l){let a=parseFloat(l.target.value);(isNaN(a)||a<e.min)&&(a=e.min);let i=l.target.closest(".input-range");a>e.max&&(i.style.setProperty("--max",a),i.querySelectorAll("input").forEach(o=>o.max=a)),i.style.setProperty(`--${l.target.id}`,a),i.querySelectorAll("input").forEach(o=>{o.id==l.target.id&&o!=l.target&&(o.value=a)}),e.callback&&e.callback(l)}};var Ce=e=>{let t=mapp.utils.html.node`
    <div
      role="group"
    ...
    <button
      class="flat"
      onclick=${()=>{e.Tabulator.download("csv",`${e.title||"table"}.csv`)}}>Download as CSV`}var ze={card:he,chkbox:ge,contextMenu:ve,drawer:be,drawing:we,dropdown:_e,dropdown_multi:ye,isoline_params_here:$e,isoline_params_mapbox:ke,legendIcon:Le,modal:Ee,slider:Se,slider_ab:Ce,toolbar_el:je};var T,v=null;async function Te(e,t){return v?new v(e,t):(T||(T=new Promise(async l=>{if(window.Chart){v=window.Chart,l();return}Promise.all([import("https://cdn.skypack.dev/chart.js@3.9.1"),import("https://cdn.skypack.dev/chartjs-plugin-datalabels@2.1.0"),import("https://cdn.skypack.dev/chartjs-plugin-annotation@2.0.1")]).then(a=>{a[0].Chart.register(...a[0].registerables),a[0].Chart.register(a[1].default),a[0].Chart.register(a[2].default),v=a[0].Chart,l()}).catch(a=>{console.error(a.message),alert("Failed to load Chart.js library. Please reload the browser.")})})),await T,new v(e,t))}var O,b=null;async function Oe(){return b?new b(...arguments):(O||(O=new Promise(async e=>{if(window.Tabulator){b=window.Tabulator,e();return}Promise.all([import("https://cdn.skypack.dev/pin/tabulator-tables@v5.3.0-3P9dSwNRL29tgc0Vmk59/mode=imports,min/optimized/tabulator-tables.js")]).then(t=>{b=t[0].TabulatorFull,e()}).catch(t=>{console.error(t.message),alert("Failed to load Tabulator library. Please reload the browser.")})})),await O,new b(...arguments))}var Me={headerFilter:{like:yt,numeric:$t,set:kt}};function yt(e){return(t,l,a,i,o)=>{let n=t.getColumn().getField();function r(s){let d=e.Tabulator.getFilters().find(c=>c.field===n&&c.type=="like");d&&(e.Tabulator.removeFilter(...Object.values(d)),o.layer&&delete e.layer.filter.current[n]),s.target.value.length&&e.Tabulator.setFilter([{field:n,type:"like",value:s.target.value}]),o.layer&&(s.target.value.length?e.layer.filter.current[n]={[o.type]:encodeURIComponent(s.target.value)}:delete e.layer.filter.current[n],e.layer.reload()),e.update()}return mapp.utils.html.node`<span>
      <input
        type="text"
        placeholder="Filter"
        oninput=${r}
        onblur=${r}>`}}function $t(e){return(t,l,a,i,o)=>{let n=t.getColumn().getField(),r=mapp.utils.html`
      <input 
        type="number" 
        placeholder="Min" 
        onchange=${s}
        onblur=${s}>`;function s(p){let u=e.Tabulator.getFilters().find(m=>m.field===n&&m.type==">=");u&&(e.Tabulator.removeFilter(...Object.values(u)),o.layer&&delete e.layer.filter.current[n]),Number(p.target.value)&&(e.Tabulator.addFilter(n,">=",Number(p.target.value)),o.layer&&(e.layer.filter.current[n]=Object.assign(e.layer.filter.current[n]||{},{gte:Number(p.target.value)}),e.layer.reload(),e.update()))}let d=mapp.utils.html`
      <input 
        type="number" 
        placeholder="Max" 
        onchange=${c}
        onblur=${c}>`;function c(p){let u=e.Tabulator.getFilters().find(m=>m.field===n&&m.type=="<=");u&&(e.Tabulator.removeFilter(...Object.values(u)),o.layer&&delete e.layer.filter.current[n]),Number(p.target.value)&&(e.Tabulator.addFilter(n,"<=",Number(p.target.value)),o.layer&&(e.layer.filter.current[n]=Object.assign(e.layer.filter.current[n]||{},{lte:Number(p.target.value)}),e.layer.reload(),e.update()))}return mapp.utils.html.node`
      <div><div style="display: flex;">${r}${d}`}}function kt(e){return(t,l,a,i,o)=>{o.set=new Set;function n(s,d){if(e.filter[s.getField()]={},d.size&&(e.filter[s.getField()].in=Array.from(d)),o.maxRows&&e.Tabulator.getDataCount()>o.maxRows-1)return e.update();if(e.Tabulator.getFilters().length){let c=e.Tabulator.getFilters().find(p=>p.field==s.getField()&&p.type=="in");c&&e.Tabulator.removeFilter(c.field,c.type,c.value)}d.size&&e.Tabulator.addFilter(s.getField(),"in",Array.from(d)),typeof o.callback=="function"&&o.callback(s,o.set)}let r=mapp.utils.html.node`
    <select style="border: 0; width: 100%; font-size: 11px;"
    onchange=${s=>{let d=s.target.value;o?.set.has(d)&&o.set.delete(d)||o.set.add(d);for(let c=0;c<s.target.options.length;c++)s.target.options[c].style.backgroundColor=o.set.has(s.target.options[c].value)&&(o.selected||"#cae0b8")||"#ffffff";n(t,o.set),s.target.value=null}}>${o.options.map(s=>mapp.utils.html.node`
