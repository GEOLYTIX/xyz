mapp.utils.merge(mapp.dictionaries,{en:{layer_zoom_to_extent:"Zoom to filtered layer extent",layer_visibility:"Toggle visibility"},de:{layer_zoom_to_extent:"Zoom zum Ausma\xDF des gefilterten Datensatzes",layer_visibility:"Umschalten der Ansicht"},cn:{layer_zoom_to_extent:"\u7F29\u653E\u81F3\u76F8\u5E94\u7B5B\u9009\u8303\u56F4",layer_visibility:"\u5207\u6362\u53EF\u89C1\u6027"},pl:{layer_zoom_to_extent:"Poka\u017C zasi\u0119g warstwy",layer_visibility:"Widoczno\u015B\u0107"},ko:{layer_zoom_to_extent:"\uD544\uD130\uB41C \uB808\uC774\uC5B4\uD06C\uAE30\uC5D0 \uC90C(zoom)",layer_visibility:"\uD1A0\uAE00 \uAC00\uC2DC\uC131"},fr:{layer_zoom_to_extent:"Zoom sur l'\xE9tendue de la couche",layer_visibility:"Changer la visiblit\xE9"},ja:{layer_zoom_to_extent:"\u30D5\u30A3\u30EB\u30BF\u30FC\u3055\u308C\u305F\u30EC\u30A4\u30E4\u30FC\u7BC4\u56F2\u3092\u30BA\u30FC\u30E0\u306B",layer_visibility:"\u8868\u793A\u5207\u66FF"}});var y=e=>{let t=mapp.utils.html`
  ...
  <div class="dropdown active">
    ...
    <div class="legend">
      ${mapp.ui.layers.styles[e.style.theme.type]&&mapp.ui.layers.styles[e.style.theme.type](e)}`),!!t.length)return e.style.drawer=mapp.ui.elements.drawer({data_id:"style-drawer",class:"raised",header:mapp.utils.html`
    ...
    <div 
      ...
      <div 
        data-id="cluster"
        class="contents">
        ${a}${l}`)}return e.style.legend=mapp.utils.html.node`<div class="grid">${i}`,e.style.legend};var B=e=>{let t=e.style.theme,i=[];return t.cat_arr.forEach(a=>{let l=Object.assign({},e.style.default,a.style&&a.style.icon||a.style||a),o=mapp.utils.html`
      <div
        style="height: 24px; width: 24px;">
        ${mapp.ui.elements.legendIcon(Object.assign({width:24,height:24},l))}`,r=mapp.utils.html`
  ...
  <div
    ...
    <button
      ...
      onclick = ${a=>{e.remove()}}>`),e.view=mapp.ui.elements.drawer({class:"location-view raised expanded",header:t});let i=e.view.appendChild(mapp.ui.locations.infoj(e));e.view.querySelector(".header").style.borderBottom=`3px solid ${e.record.colour}`,e.view.addEventListener("valChange",a=>{a.detail.value!=a.detail.newValue?a.detail.node.classList.add("val-changed"):(delete a.detail.newValue,a.detail.node.classList.remove("val-changed")),e.view.querySelector(".cloud-upload").style.display=e.infoj.some(l=>typeof l.newValue<"u")&&"inline-block"||"none"}),e.view.addEventListener("updateInfo",()=>{i.remove(),e.view.querySelector(".cloud-upload").style.display="none",e.view.classList.remove("disabled"),i=mapp.ui.locations.infoj(e),e.view.appendChild(i)})};mapp.utils.merge(mapp.dictionaries,{en:{location_clear_all:"Clear locations"},de:{location_clear_all:"Entferne Auswahl"},cn:{location_clear_all:"\uBAA8\uB4E0 \uC704\uCE58 \uC81C\uAC70"},pl:{location_clear_all:"Wyczy\u015B\u0107 selekcje"},ko:{location_clear_all:"\u6E05\u9664\u6240\u6709\u5730\u70B9"},fr:{location_clear_all:"Des\xE9lectionner tous les lieux."},ja:{location_clear_all:"\u5168\u30ED\u30B1\u30FC\u30B7\u30E7\u30F3\u3092\u30AF\u30EA\u30A2"}});var J=[{symbol:"A",colour:"#2E6F9E"},{symbol:"B",colour:"#EC602D"},{symbol:"C",colour:"#5B8C5A"},{symbol:"D",colour:"#B84444"},{symbol:"E",colour:"#514E7E"},{symbol:"F",colour:"#E7C547"},{symbol:"G",colour:"#368F8B"},{symbol:"H",colour:"#841C47"},{symbol:"I",colour:"#61A2D1"},{symbol:"J",colour:"#37327F"}],Z=e=>{if(!e.mapview||!e.target)return;let t={node:e.target,mapview:e.mapview},i=t.node.appendChild(mapp.utils.html.node`
    <button 
      ...
      ${mapp.dictionary.location_clear_all}`);return e.mapview.locations=new Proxy(e.mapview.locations,{set:function(a,l,o){let r=J.find(n=>!n.hook);return r.hook=o.hook,o.record=r,o.style={strokeColor:r.colour,fillColor:r.colour,fillOpacity:.2},o.Style=mapp.utils.style([{strokeColor:"#000",strokeOpacity:.1,strokeWidth:8},{strokeColor:"#000",strokeOpacity:.1,strokeWidth:6},{strokeColor:"#000",strokeOpacity:.1,strokeWidth:4},{strokeColor:o.style.strokeColor||"#000",strokeWidth:2,fillColor:o.style.fillColor||o.style.strokeColor||"#fff",fillOpacity:o.style.fillOpacity||.2}]),o.pinStyle=mapp.utils.style({icon:{type:"markerLetter",letter:r.symbol,color:o.style.strokeColor,scale:3,anchor:[.5,1]}}),Reflect.set(...arguments),mapp.ui.locations.view(o),Object.values(t.node.children).forEach(n=>n.classList.remove("expanded")),t.node.insertBefore(o.view,i.nextSibling),o.view.dispatchEvent(new Event("addLocationView")),i.style.display="block",document.querySelector("[data-id=locations]").click(),!0},deleteProperty:function(a,l){Reflect.deleteProperty(...arguments);let o=J.find(r=>r.hook===l);return o&&delete o.hook,setTimeout(()=>{if(!document.querySelectorAll("#locations > .location-view").length){document.querySelector("[data-id=layers]").click(),i.style.display="none";let r=document.querySelector("#locations #gazetteerInput");r?r.value="":document.querySelector("[data-id=locations]").style.display="none"}},300),!0}}),t};var X=(e,t)=>{if(!e.infoj)return;let i=mapp.utils.html.node`<div class="location-view-grid">`,a={};for(let l of t||e.infoj){if(e.view&&e.view.classList.contains("disabled"))break;if(l.listview=i,l.type=l.type||"text",l.skipEntry||l.skipFalsyValue&&!l.value&&!l.edit||l.skipUndefinedValue&&typeof l.value>"u"&&!l.edit||l.skipNullValue&&l.value===null&&!l.edit)continue;l.nullValue&&l.value===null&&!l.defaults&&!l.edit&&(l.value=l.nullValue),l.group&&(a[l.group]||(a[l.group]=l.listview.appendChild(mapp.ui.elements.drawer({class:`group ${l.expanded&&"expanded"||""}`,header:mapp.utils.html`
              <h3>${l.group}</h3>
      ...
      <div
        ...
        <div
          class="label"
          style="${`${l.css_title||""}`}"
          title="${l.tooltip||null}">${l.title}`),(l.value===null||typeof l.value>"u")&&(l.value=l.default||l.value);let o=mapp.ui.locations.entries[l.type]&&mapp.ui.locations.entries[l.type](l);if(o==="break")break;o&&l.node.append(o)}return i};var K=e=>{let t=mapp.ui.elements.chkbox({label:e.label||e.title,checked:e.value,disabled:!e.edit,onchange:a=>{e.newValue=a,e.location.view?.dispatchEvent(new CustomEvent("valChange",{detail:e}))}});return mapp.utils.html.node`${t}`};var Q=e=>{e.layer=e.location.layer,e.host=e.host||e.location.layer.mapview.host,e.dependents&&e.dependents.some(r=>e.location.infoj.some(n=>!n.value&&n.field===r))&&delete e.display;let t;if(typeof e.target=="string"&&document.getElementById(e.target)){e.target=document.getElementById(e.target),mapp.ui.Dataview(e).then(()=>e.update());return}let i=typeof e.target=="string"&&document.querySelector(`[data-id=${e.target}]`);i&&(delete e.target,e.display&&a());function a(){if(e.show)return e.show();mapp.ui.Dataview(e).then(()=>{e.tab_style=`border-bottom: 3px solid ${e.location.style.strokeColor}`,i.dispatchEvent(new CustomEvent("addTab",{detail:e})),e.display&&e.show()})}typeof e.target=="string"&&(t=mapp.utils.html.node`
      <div
        class="${`location ${e.class}`}">`,e.target=t,e.display&&mapp.ui.Dataview(e).then(()=>e.update()));let l=e.label&&mapp.ui.elements.chkbox({label:e.label,checked:!!e.display,onchange:r=>{if(e.display=r,t){t.style.display=e.display?"block":"none",e.display&&typeof e.update=="function"&&e.update(),e.display&&typeof e.update!="function"&&mapp.ui.Dataview(e).then(()=>e.update());return}e.display?a():e.remove()}});return mapp.utils.html.node`${l}${t||""}`};var x=e=>{let t;return e.edit?t=mapp.utils.html.node`
      <input
    ...
    <div
      class="images-grid">${t}`;return a;async function l(r){e.location.view?.classList.add("disabled");let n=new FileReader,s=r.target.files[0];!s||(n.onload=c=>{let d=new Image;d.onload=async()=>{let u=mapp.utils.html.node`<canvas>`,m=1024,h=d.width,g=d.height;h>g&&h>m?(g*=m/h,h=m):g>m&&(h*=m/g,g=m),u.width=h,u.height=g,u.getContext("2d").drawImage(d,0,0,h,g);let Pe=u.toDataURL("image/jpeg",.5),_=await mapp.utils.xhr({method:"POST",requestHeader:{"Content-Type":"application/octet-stream"},url:`${e.location.layer.mapview.host}/api/provider/cloudinary?${mapp.utils.paramString({public_id:s.name.replace(/.*\//,"").replace(/\.([\w-]{3})/,""),resource_type:"image"})}`,body:mapp.utils.dataURLtoBlob(Pe)});await mapp.utils.xhr(`${e.location.layer.mapview.host}/api/query?`+mapp.utils.paramString({template:"set_field_array",locale:e.location.layer.mapview.locale.key,layer:e.location.layer.key,table:e.location.table,qID:e.location.layer.qID,id:e.location.id,action:"append",field:e.field,value:_.secure_url}));let Ae=mapp.utils.html.node`
          <div>
            <img
              src=${_.secure_url}
              onclick=${mapp.ui.utils.imagePreview}>
    ...
    <div
      class="val"
      style="${`${e.css_val||""}`}">
      ${e.prefix}${i}${e.suffix}`,t};function Ke(e){let t=e.edit.options.find(l=>typeof l=="object"&&Object.values(l)[0]===e.value||l===e.value)||e.value;e.value=t&&typeof t=="object"&&Object.keys(t)[0]||t||e.value||" ";let i=e.edit.options.map(l=>({title:typeof l=="string"&&l||Object.keys(l)[0],option:typeof l=="string"&&l||Object.values(l)[0]}));return mapp.ui.elements.dropdown({span:e.value,entries:i,callback:(l,o)=>{e.newValue=o.option,e.location.view?.dispatchEvent(new CustomEvent("valChange",{detail:e}))}})}var E=e=>{e.query&&mapp.utils.xhr(`${e.location.layer.mapview.host}/api/query/${e.query}`).then(a=>{e.node.querySelector(".val").innerHTML=a[e.params.field]});let t=e.type!=="html"?e.value:"";e.edit&&(t=mapp.utils.html`
    <textarea
      style="auto; min-height: 50px;"
      onfocus=${a=>{a.target.style.height=a.target.scrollHeight+"px"}}
      onfocusout=${a=>{a.target.style.height="auto"}}
  ...
  <div
    ...
    <div
      class="val"
      style="${`${e.css_val||""}`}">
      ${t}`};var ce={key:Qe,boolean:K,dataview:Q,date:x,datetime:x,defaults:Y,documents:ee,geometry:te,html:E,images:ae,integer:S,isoline_here:L,isoline_mapbox:L,json:ie,numeric:S,pin:le,report:oe,streetview:ne,tab:re,text:se,textarea:E,time:de};function Qe(e){return mapp.utils.html.node`
  <div class="layer-key">
    <span>
      ${e.location.layer.name}`}var pe={view:W,listview:Z,infoj:X,entries:ce};var ue=async e=>{if(e.target=typeof e.target=="string"&&document.getElementById(e.target)||e.target,e.target=e.target instanceof HTMLElement&&e.target||mapp.utils.html.node`<div class="dataview-target">`,e.update=async()=>{if(!e.query)return;let t=mapp.utils.queryParams(e),i=mapp.utils.paramString(t),a=await mapp.utils.xhr(`${e.host||e.location.layer.mapview.host}/api/query?${i}`);if(!(a instanceof Error)){if(typeof e.responseFunction=="function")return e.responseFunction(a);typeof e.setData=="function"&&e.setData(a)}},e.toolbar){e.target=mapp.utils.html.node`<div class="dataview-target">`;let t=Object.keys(e.toolbar).map(i=>mapp.ui.elements.toolbar_el[i](e));e.panel=mapp.utils.html.node`
      <div class="flex-col">
        <div class="btn-row">${t}</div>
        ${e.target}`}return e.chart&&await Ye(e),typeof e.columns<"u"&&(console.warn("Table dataviews should be configured inside a tables object"),e.table={columns:e.columns}),e.table&&await et(e),e.mapChange&&e.layer&&e.layer.mapview.Map.getTargetElement().addEventListener("changeEnd",()=>{e.layer&&!e.layer.display||e.tab&&!e.tab.classList.contains("active")||typeof e.mapChange=="function"&&e.mapChange()||e.update()}),e};async function Ye(e){let t=e.target.appendChild(mapp.utils.html.node`<canvas>`);e.ChartJS=await mapp.ui.utils.Chart(t,mapp.utils.merge({type:"bar",options:{plugins:{legend:{display:!1},datalabels:{display:!1}}}},e.chart)),e.setData=i=>{e.noDataMask&&!i?(e.target.style.display="none",e.mask=!e.mask&&e.target.parentElement?.appendChild(mapp.utils.html.node`
        <div class="dataview-mask">No Data`)):(e.mask&&e.mask.remove(),delete e.mask,e.target.style.display="block"),i||(i={datasets:[{data:[]}]}),i.datasets||(i={datasets:[{data:i}]}),e.data=i,e.chart.datasets?.length&&i.datasets.forEach((a,l)=>Object.assign(a,e.chart.datasets[l])),i.labels=i.labels||e.chart.labels,e.ChartJS.data=i,e.ChartJS.update()}}async function et(e){e.table.columns.forEach(t=>{t.headerFilter&&typeof t.headerFilter!="function"&&(t.headerFilter=(i,a,l,o,r)=>{let n=tt[r.type](e,i,a,l,o,r);return console.log(n),n})}),e.Tabulator=await mapp.ui.utils.Tabulator(e.target,Object.assign({renderVertical:"basic"},e.table)),e.table.selectable&&e.Tabulator.on("rowClick",(t,i)=>{if(typeof e.rowSelect=="function"){e.rowSelect(t,i);return}let a=i.getData();!e.layer||!a[e.layer.qID]||(mapp.location.get({layer:e.layer,id:a[e.layer.qID]}),i.deselect())}),typeof e.events=="object"&&Object.entries(e.events).forEach(t=>{typeof t[1]=="function"&&e.Tabulator.on(t[0],t[1])}),e.setData=t=>{!t&&e.data||(e.noDataMask&&!t?(e.target.style.display="none",e.mask=!e.mask&&e.target.parentElement?.appendChild(mapp.utils.html.node`
        <div class="dataview-mask">No Data`)):(e.mask&&e.mask.remove(),delete e.mask,e.target.style.display="block"),t=!t&&[]||t.length&&t||[t],e.Tabulator.setData(t),e.data=t,typeof e.setDataCallback=="function"&&e.setDataCallback(e))}}var tt={like:at,numeric:it};function at(e,t,i,a,l,o){return mapp.utils.html.node`<span>
  <input
    type="text"
    placeholder="Filter"
    oninput=${r=>{let n=t.getColumn().getField();r.target.value.length?e.layer.filter.current[n]={[o.type]:encodeURIComponent(r.target.value)}:delete e.layer.filter.current[n],e.layer.reload(),e.update()}}>`}function it(e,t,i,a,l,o){return mapp.utils.html.node`<span>
    <input
      style="width: 50%"
      type="number"
      placeholder="Min"
      oninput=${r=>{let n=t.getColumn().getField();r.target.value.length?e.layer.filter.current[n]=Object.assign(e.layer.filter.current[n]||{},{gte:Number(r.target.value)}):delete e.layer.filter.current[n],e.layer.reload(),e.update()}}></input>
    <input
      style="width: 50%"
      type="number"
      placeholder="Max"
      oninput=${r=>{let n=t.getColumn().getField();r.target.value.length?e.layer.filter.current[n]=Object.assign(e.layer.filter.current[n]||{},{lte:Number(r.target.value)}):delete e.layer.filter.current[n],e.layer.reload(),e.update()}}></input>`}var me=e=>{!e.node||(e.tabs=e.node.appendChild(mapp.utils.html.node`<div class="tabs">`),e.panel=e.node.appendChild(mapp.utils.html.node`<div class="panel">`),e.id&&e.node.setAttribute("data-id",e.id),e.addTab=lt,e.node.addEventListener("addTab",t=>e.addTab(t.detail)))};function lt(e){let t=this;e.tab=mapp.utils.html.node`
    <div class="tab">
      <div
        class="header"
        style="${e.tab_style||""}"
  ...
  <label 
    ...
    <li
      ...
      ${mapp.dictionary.cancel}`),this.popup({coords:this.interaction.vertices[this.interaction.vertices.length-1],content:mapp.utils.html.node`<ul>${t}`})}function nt(e){if(this.interaction.vertices.length===0)return;e&&e.preventDefault();let t=this.interaction.Layer.getSource().getFeatures(),i=[];t.length&&i.push(mapp.utils.html`
  <li
    onclick=${()=>this.interaction.finish(this.interaction.getFeature())}>
  ...
  <button 
    ...
    <input
      type="datetime-local"
      onchange=${c=>{e.dateISO=new Date(c.target.value).toISOString()}}>`,o=mapp.utils.html.node`
    <div>
      ${a}
      ${l}`,r=mapp.ui.elements.slider({label:mapp.dictionary.here_range_minutes,min:e.rangeMin,max:e.rangeMax,val:10,callback:c=>{e.range=parseInt(c.target.value)}}),n=mapp.ui.elements.chkbox({label:"Reverse Direction Isoline",checked:!!e.reverseDirection,onchange:c=>{a.textContent=c&&mapp.dictionary.here_datetime_arrive||mapp.dictionary.here_datetime_depart,e.reverseDirection=c}});return mapp.ui.elements.drawer({header:mapp.utils.html`
      <h3>Here Isoline</h3>
    ...
    <div
      ...
      <input id="b" type="range"
        ...
        step=${e.step||1}
        value=${e.val_b}
        oninput=${i}/>`;function i(a){t.style.setProperty(`--${a.target.id}`,a.target.value),t.querySelectorAll("input").forEach(l=>{l.id==a.target.id&&l!=a.target&&(l.value=a.target.value)}),a.target.id==="a"&&typeof e.callback_a=="function"&&e.callback_a(a),a.target.id==="b"&&typeof e.callback_b=="function"&&e.callback_a(b)}return t};var Ee={viewport:ft,download_json:vt,download_csv:wt};function ft(e){return mapp.utils.html`
    <button
    ...
    <button
      class="flat"
      onclick=${()=>{e.Tabulator.download("json",`${e.title||"table"}.json`)}}>Export as JSON`}function wt(e){return mapp.utils.html`
    <button
      class="flat"
      onclick=${()=>{e.Tabulator.download("csv",`${e.title||"table"}.csv`)}}>Download as CSV`}var Ce={card:he,chkbox:ge,contextMenu:fe,drawer:ve,drawing:we,dropdown:be,dropdown_multi:_e,isoline_params_here:ye,isoline_params_mapbox:$e,legendIcon:xe,slider:Le,slider_ab:Se,toolbar_el:Ee};var C,v=null;async function je(e,t){return v?new v(e,t):(C||(C=new Promise(async i=>{if(window.Chart){v=window.Chart,i();return}Promise.all([import("https://cdn.skypack.dev/chart.js@3.7.0"),import("https://cdn.skypack.dev/chartjs-plugin-datalabels@2.0.0"),import("https://cdn.skypack.dev/chartjs-plugin-annotation@1.4.0")]).then(a=>{a[0].Chart.register(...a[0].registerables),a[0].Chart.register(a[1].default),a[0].Chart.register(a[2].default),v=a[0].Chart,i()}).catch(a=>{console.error(a.message),alert("Failed to load Chart.js library. Please reload the browser.")})})),await C,new v(e,t))}var j,w=null;async function ze(){return w?new w(...arguments):(j||(j=new Promise(async e=>{if(window.Tabulator){w=window.Tabulator,e();return}Promise.all([import("https://cdn.skypack.dev/-/tabulator-tables@v5.2.7-uFL2B6RLQMMWIcn9QymG/dist=es2019,mode=imports/optimized/tabulator-tables.js")]).then(t=>{w=t[0].TabulatorFull,e()}).catch(t=>{console.error(t.message),alert("Failed to load Chart.js library. Please reload the browser.")})})),await j,new w(...arguments))}var p={idle:600},Te=e=>{Object.assign(p,e),p.idle!==0&&(window.onload=f,window.onmousemove=f,window.onmousedown=f,window.ontouchstart=f,window.onclick=f,window.onkeypress=f,f(),z())};function f(){p.locked||(p.timeout&&clearTimeout(p.timeout),p.timeout=setTimeout(Oe,p.idle*1e3))}function Oe(){p.locked=!0,p.renew&&clearTimeout(p.renew);let e=new XMLHttpRequest;e.open("GET",`${p.host}/api/user/cookie?destroy=true`),e.send();let t=mapp.utils.html.node`
    <form
      class="login"
      action="${`${p.host}/api/user/login`}"
      method="post"
      autocomplete="off">
    ...
    </form>`;t.onsubmit=i=>{i.preventDefault();let a=new XMLHttpRequest;a.open("POST",`${p.host}/api/user/login`),a.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),a.onload=l=>{l.target.status===401&&(t.querySelector(".msg").textContent=l.target.response),l.target.status===200&&(delete p.locked,p.mask.remove(),f(),z())},a.send(`login=true&email=${t.querySelector("#auth_user_email").value}&password=${t.querySelector("#auth_user_password").value}`)},p.mask=document.body.appendChild(mapp.utils.html.node`
    <div class="interface-mask">${t}`)}function z(){p.renew=setTimeout(e,(p.idle-20)*1e3);function e(){let t=new XMLHttpRequest;t.open("GET",`${p.host}/api/user/cookie?renew=true`),t.onload=i=>{if(i.target.status===401)return Oe();z()},t.send()}}var De=e=>{document.body.append(mapp.utils.html.node`
    <div class="interface-mask">
      <div class="bg-image" style=${`background-image:url(${e.target.src})`}>
      <button class="btn-close mask-icon close"
        onclick=${t=>t.target.parentElement.parentElement.remove()}>`)};var qe=e=>{e.target.addEventListener("mousedown",i=>{i.preventDefault(),document.body.style.cursor="grabbing",window.addEventListener("mousemove",e.resizeEvent),window.addEventListener("mouseup",t)}),e.target.addEventListener("touchstart",i=>{i.preventDefault(),window.addEventListener("touchmove",e.resizeEvent),window.addEventListener("touchend",t)},{passive:!0});function t(){document.body.style.cursor="auto",window.removeEventListener("mousemove",e.resizeEvent),window.removeEventListener("touchmove",e.resizeEvent),window.removeEventListener("mouseup",t),window.removeEventListener("touchend",t)}};var Me={Chart:je,Tabulator:ze,idleMask:Te,imagePreview:De,resizeHandler:qe};var Fe=e=>{let t=Object.assign({input:e.target.querySelector("input"),result:e.target.querySelector("ul"),sources:{glx:a,mapbox:o,google:l}},e);t.input.placeholder=t.placeholder||"",t.input.oninput=n=>{t.xhr&&t.xhr.abort(),t.result.innerHTML="",n.target.value.length>0&&i(n.target.value)},t.input.addEventListener("keydown",n=>{(n.keyCode||n.charCode)===13&&t.result.querySelector("li").click()});function i(n){let s=n.split(",").map(parseFloat);if(s.length===2&&s.every(c=>!isNaN(c))){t.result.appendChild(mapp.utils.html.node`
      <li 
        onclick=${c=>{t.result.innerHTML="",r({label:`Latitude:${s[0]}, Longitude:${s[1]}`,source:"Coordinates",lng:s[1],lat:s[0]})}}><span>Latitutde:${s[0]}, Longitude:${s[1]}`);return}t.xhr=new XMLHttpRequest,t.xhr.open("GET",t.mapview.host+"/api/gazetteer?"+mapp.utils.paramString({locale:t.mapview.locale.key,layer:t.layer,q:encodeURIComponent(n)})),t.xhr.setRequestHeader("Content-Type","application/json"),t.xhr.responseType="json",t.xhr.onload=c=>{if(c.target.status===200){if(c.target.response.length===0)return t.result.appendChild(mapp.utils.html.node`
          ...
          <li
            onclick=${u=>{if(t.result.innerHTML="",t.callback)return t.callback(d);t.sources[d.source]({label:d.label,id:d.id,source:d.source,layer:d.layer,table:d.table,marker:d.marker,callback:e.callback})}}>
            <span class="label">${t.mapview.layers[d.layer]&&t.mapview.layers[d.layer].name||d.layer||d.source}</span>
            <span>${d.label}</span>`)})}},t.xhr.send()}function a(n){mapp.location.get({layer:t.mapview.layers[n.layer],table:n.table,id:n.id}).then(s=>s.flyTo())}function l(n){mapp.utils.xhr(`${t.mapview.host}/api/proxy?url=${encodeURIComponent(`https://maps.googleapis.com/maps/api/place/details/json?placeid=${n.id}&{GOOGLE}`)}`).then(s=>{r({label:n.label,source:n.source,lng:s.result.geometry.location.lng,lat:s.result.geometry.location.lat})})}function o(n){r({label:n.label,source:n.source,lng:n.marker[0],lat:n.marker[1]})}function r(n){Object.assign(n,{layer:{mapview:t.mapview},Layers:[],hook:n.label});let s=[{title:n.label,value:n.source},{type:"pin",value:[n.lng,n.lat],srid:"4326",class:"display-none",location:n}];mapp.location.decorate(Object.assign(n,{infoj:s})),t.mapview.locations[n.hook]=n,n.flyTo()}};var Ie={layers:U,locations:pe,elements:Ce,utils:Me,Gazetteer:Fe,Dataview:ue,Tabview:me};typeof window.mapp=="object"&&(window.mapp.ui=Ie);var zi=Ie;export{zi as default};
