import{t as e}from"./chunk-DK3Fl9T5.js";async function t(e){if(!(!e.dynamic&&typeof e.create==`function`)){if(typeof e.create==`function`){e.create();return}if(typeof e.target==`string`&&(e.target=document.getElementById(e.target)),!(e.target instanceof HTMLElement)){console.warn(`Dataviews require a HTMLHtmlElement target`);return}return i(e)instanceof Error?e.err:(typeof e.label==`string`&&(e.chkbox=mapp.ui.elements.chkbox({checked:!!e.display,data_id:e.key,disabled:e.disabled,label:e.label,onchange:t=>{e.display=t,e.display?e.show():e.hide()}})),e.update??=a,e.show??=n,e.hide??=r,mapp.ui.utils.dataview.Toolbar(e),mapp.ui.utils.dataview.mapChange(e),e)}}async function n(){this.display=!0,this.create===void 0?(this.create=()=>{mapp.ui.utils[this.dataview].create(this)},this.create(),typeof this.update==`function`&&this.update()):this.dynamic?(typeof this.create==`function`&&await this.create(),typeof this.update==`function`&&this.update()):this.reload&&typeof this.update==`function`&&this.update(),this.btnRow?.style.setProperty(`display`,`flex`),this.target.style.display=`block`}function r(){this.display=!1,this.target.style.display=`none`,this.btnRow?.style.setProperty(`display`,`none`)}function i(e){if(e.key??=e.query||e.title||e.label,e.dataview||(e.chart&&(e.dataview=`chartjs`),e.columns!==void 0&&(console.warn(`Table dataviews should be configured inside a tables object`),e.table={columns:e.columns},e.dataview=`tabulator`),e.table&&(e.dataview=`tabulator`)),!Object.hasOwn(mapp.ui.utils,e.dataview))return e.err=Error(`mapp.ui.utils.${e.dataview} doesnt exist`),console.error(e.err),e.update=()=>console.warn(`Unable to update ${e.key} dataview.`),e.err;if(typeof mapp.ui.utils[e.dataview].create!=`function`)return e.err=Error(`mapp.ui.utils.${e.dataview}.create() method doesn't exist`),console.error(e.err),e.err}async function a(){if(this.create===void 0&&(this.create=function(){mapp.ui.utils[this.dataview].create(this)},this.create()),!this.query)return;let e=mapp.utils.queryParams(this),t=mapp.utils.paramString(e);this.host??=this.layer?.mapview?.host;let n=await mapp.utils.xhr(`${this.host||mapp.host}/api/query?${t}`);if(!(n instanceof Error)){if(typeof this.responseFunction==`function`){this.responseFunction(n);return}typeof this.setData==`function`&&this.setData(n)}}function o(e){typeof e==`string`&&(e={text:e}),e.title??=mapp.dictionary.information,e.icon??=`info`,e.data_id??=`alert`,e.class??=`alert-confirm box-shadow no-select`;let t=e.icon===``?``:mapp.utils.html`<span class="material-symbols-outlined notranslate">${e.icon}</span>`;return e.header=mapp.utils.html`${t}${e.title}`,e.innerContent??=mapp.utils.html`<p>${e.text}</p>`,e.content=mapp.utils.html`
  ...
  <li
    ...
    class=${e.classList}>
    ${e.icon}`,this.tabs.append(e.tab),this.panels.append(e.panel)}function ie(e,t){for(let e of Array.from(t.parent.tabs.children))e.classList.remove(`active`);t.tab.classList.add(`active`);for(let e of Array.from(t.parent.panels.children))e.classList.remove(`active`);t.panel.classList.add(`active`),t.focus&&(t.focus=t.focus instanceof HTMLElement?t.focus:document.querySelector(`[name=${t.focus}]`),t.focus.focus())}function ae(e){if(!e.new&&typeof e.show==`function`){e.show();return}if(e.show=ce,!e.target)e.modal=!0;else if(e.target instanceof HTMLElement)e.show=ce;else return;document.querySelector(`dialog.modal`)?.close(),e.minimizeBtn&&=mapp.utils.html`<button
    data-id="minimize"
  ...
  <button
    ...
    <button
      ...
      ${e.draw.locator.label}`,e.draw.locator.btn}function xe(e){e.selectedTitles=new Set,e.selectedOptions=new Set,e.placeholder??=e.span||``,e.entries=e.entries?.filter?.(e=>e.option!==``),Ce(e),we(e),e.onChange??=g,e.options=Se(e);let t=e.selectedTitles.size?Array.from(e.selectedTitles).join(`, `):e.placeholder,n=e.keepPlaceholder?e.placeholder:t;return e.placeHolderOption=mapp.utils.html.node`
    ...
    ${e.pills?.container}
    ${e.search||e.select}`,e.node}function h(e){e.target.selectedIndex=0}function g(e,t){let n=e.target.selectedIndex;e.target.selectedIndex=0;let r=t.entries[n-1];if(r.selected=!r.selected,t.multi){if(t.options[n].classList.toggle(`selected`)?(t.selectedTitles.add(r.title),t.selectedOptions.add(r.option),t.pills?.add(r.title)):(t.selectedTitles.delete(r.title),t.selectedOptions.delete(r.option),t.pills?.remove(r.title)),!t.pills&&!t.keepPlaceholder){let e=t.selectedTitles?.size&&Array.from(t.selectedTitles).join(`, `);t.placeHolderOption.textContent=e||t.placeholder}t.callback?.(e,[...t.selectedOptions],r);return}t.options.forEach(e=>{e.classList.remove(`selected`),e.style.backgroundColor=`var(--color-base-secondary)`}),t.options[n].classList.add(`selected`),t.options[n].style.removeProperty(`background-color`),t.keepPlaceholder||(t.placeHolderOption.textContent=r.title),t.callback?.(e,r)}function Se(e){return e.entries.map(t=>(t.li=mapp.utils.html.node`<option
        value=${t.option}>
        ${t.title||t.label||t.field}`,t.selected&&(t.li.classList.add(`selected`),e.selectedTitles.add(t.title),e.selectedOptions.add(t.option),e.pills?.add(t.title)),t.li))}function Ce(e){e.pills&&=mapp.ui.elements.pills({addCallback:(t,n)=>{e.callback?.(null,[...n])},pills:[...e.selectedTitles],removeCallback:(t,n)=>{let r=e.entries.findIndex(e=>e.option===t),i=e.entries.findIndex(e=>e.option===t)+1;e.entries.find(e=>e.option===t).selected=!1,e.options[i].classList.remove(`selected`),e.selectedTitles.delete(r.title),e.selectedOptions.delete(r.option),e.callback?.(null,[...n])}})}function we(e){if(!e.search)return;let t=`${e.field}-search-options`,n=e.placeholder||`Enter search term...`,r=mapp.utils.html.node`<input
    placeholder=${n}
    type="search" list=${t}
    onInput=${t=>Te(t,e)}
    onfocus="this.placeholder=''"
    onblur=${e=>e.target.placeholder=n}>`;e.searchOptions=[];for(let t of e.entries){let n=mapp.utils.html.node`
      <option value=${t.option} data-title=${t.title}>${t.title}`;e.searchOptions.push(n)}let i=mapp.utils.html.node`<datalist id=${t}>${e.searchOptions}`;return e.search=mapp.utils.html.node`${r}${i}`,e.search}function Te(e,t){t.entries.forEach(n=>{n.title===e.target.value&&(n.selected=!n.selected,n.selected?(t.selectedTitles.add(n.title),t.selectedOptions.add(n.option),t.pills?.add(n.title)):(t.selectedTitles.delete(n.title),t.selectedOptions.delete(n.option),t.pills?.remove(n.title)),e.target.value=``,e.target.dispatchEvent(new Event(`blur`)),t.pills||t.callback?.(e,[...t.selectedOptions]))})}var _;function Ee(e){_?.node.remove(),e&&(mapp.user?.hideHelp||(_={closeBtn:!0,contained:!0,css_style:`padding: 0.5em;`,headerDrag:!0,height:`auto`,left:`6em`,minimizeBtn:!0,target:document.getElementById(`Map`),top:`3em`,...e},mapp.ui.elements.dialog(_)))}async function De(e){let t=await mapp.utils.esmImport(`vanilla-jsoneditor@3.3.1`);return e.content??={json:{}},typeof e.data==`object`&&(e.content.json=e.data),t.createJSONEditor({props:{content:e.content,...e.props},target:e.target})}var v={hover:ke,hovers:Ae,icon_scaling:Ie,label:je,labels:Me,opacitySlider:Ne,panel:Oe,theme:Pe,themes:Fe};function Oe(e){if(!e.style)return;e.style.elements??=Object.keys(e.style);let t=[];for(let n of e.style.elements){if(!Object.hasOwn(e.style,n)||!Object.hasOwn(v,n))continue;let r=v[n](e);r&&t.push(r)}if(t.length)return e.style.view=mapp.utils.html.node`<div>${t}`,e.style.view}function ke(e){if(e.style.hover&&!e.style.hover.hidden)return mapp.ui.elements.chkbox({checked:!!e.style.hover.display,data_id:`hoverCheckbox-${e.key}`,label:e.style.hovers&&mapp.dictionary.layer_style_display_hover||e.style.hover.title||mapp.dictionary.layer_style_display_hover,onchange:t=>{e.style.hover.display=t}})}function Ae(e){if(!e.style.hover||e.style.hover.hidden||!e.style.hovers||Object.keys(e.style.hovers).length<2)return;let t=Object.keys(e.style.hovers).filter(t=>!e.style.hovers[t].hidden).map(t=>({option:t,title:e.style.hovers[t].title||t}));return mapp.ui.elements.dropdown({callback:(t,n)=>{let r=e.style.hover.display;e.style.hover=e.style.hovers[n.option],e.style.hover.method??=mapp.layer.featureHover,e.style.hover.display=r},data_id:`hoversDropdown-${e.key}`,entries:t,placeholder:e.style.hover.title})}function je(e){if(!e.style.label||e.style.label.hidden)return;if(e.style.labelCheckbox)return e.style.labelCheckbox;let t=e.style.labels&&mapp.dictionary.layer_style_display_labels;return t??=e.style.label.title||mapp.dictionary.layer_style_display_labels,e.style.labelCheckbox=mapp.ui.elements.chkbox({checked:!!e.style.label.display,data_id:`labelCheckbox-${e.key}`,label:t,onchange:t=>{e.style.label.display=t,e.reload()}}),e.changeEndCallbacks.push(y),e.style.labelCheckbox}function y(e){if(e.style.label.minZoom||e.style.label.maxZoom){let t=e.mapview.Map.getView().getZoom();t<=e.style.label.minZoom||t>=e.style.label.maxZoom?e.style.labelCheckbox?.classList.add(`disabled`):e.style.labelCheckbox?.classList.remove(`disabled`)}}function Me(e){if(!e.style.label||e.style.label.hidden||!e.style.labels||Object.keys(e.style.labels).length<2)return;let t=Object.keys(e.style.labels).filter(t=>!e.style.labels[t].hidden).map(t=>({option:t,title:e.style.labels[t].title||t}));return mapp.utils.html`
  <div>${mapp.dictionary.layer_style_select_label}</div>
  ${mapp.ui.elements.dropdown({callback:n,data_id:`labelsDropdown`,entries:t,placeholder:e.style.label.title})}`;function n(t,n){let r=e.style.label.display;e.style.label=e.style.labels[n.option],e.style.label.display=r,e.reload(),y(e)}}function Ne(e){return mapp.ui.elements.slider({callback:t=>{e.L.setOpacity(Number.parseFloat(t/100))},data_id:`opacitySlider`,label:`${mapp.dictionary.layer_style_opacity}`,max:100,min:0,val:Number.parseInt(e.L.getOpacity()*100)})}function Pe(e){if(!e.style.theme)return;e.style.labels&&Object.hasOwn(e.style.labels,e.style.theme?.setLabel)&&(e.style.label=e.style.labels[e.style.theme.setLabel]),e.style.hovers&&Object.hasOwn(e.style.hovers,e.style.theme?.setHover)&&(e.style.hover=e.style.hovers[e.style.theme.setHover]);let t=[];return e.style.theme?.meta&&(e.style.theme.meta_node=mapp.utils.html.node`<p>${e.style.theme.meta}`,t.push(e.style.theme.meta_node)),Object.hasOwn(mapp.ui.layers.legends,e.style.theme?.type)&&(e.style.legend=mapp.utils.html.node`<div class="legend">`,t.push(e.style.legend),Object.hasOwn(mapp.layer.featureFields.distribution,e.style.theme.distribution)||e.showCallbacks.push(()=>{mapp.ui.layers.legends[e.style.theme.type](e)})),mapp.utils.html.node`<div data-id="layerTheme">${t}`}function Fe(e){if(!e.style.themes||Object.keys(e.style.themes).length<2)return;let t=Object.keys(e.style.themes).map(t=>({option:t,title:e.style.themes[t].title||t}));function n(t,n){e.style.theme=e.style.themes[n.option],e.style.theme.setLabel&&e.style.labels&&(e.style.label=e.style.labels[e.style.theme.setLabel]),e.style.theme.setHover&&e.style.hovers&&(e.style.hover=e.style.hovers[e.style.theme.setHover],e.style.hover.method??=mapp.layer.featureHover);let r=mapp.ui.layers.panels.style(e);e.style.panel&&e.style.panel.replaceChildren(...r.children),e.view?.querySelector(`[data-id=style-drawer]`).replaceChildren(...r.children),e.reload()}return mapp.utils.html`<div>
    ${mapp.dictionary.layer_style_select_theme}
    ${mapp.ui.elements.dropdown({callback:n,data_id:`themesDropdown`,entries:t,placeholder:e.style.theme.title})}`}function Ie(e){if(!e.style.icon_scaling||e.style.icon_scaling.hidden)return;let t=[];if(e.style.icon_scaling.fields){let n=Object.keys(e.style.icon_scaling.fields).map(t=>({option:e.style.icon_scaling.fields[t].field,title:e.style.icon_scaling.fields[t].title||t,key:t}));n.push({title:mapp.dictionary.icon_scaling_no_scaling}),e.style.icon_scaling.placeholder??=mapp.dictionary.icon_scaling_select_one,e.style.icon_scaling.title??=mapp.dictionary.icon_scaling_title;let r=Object.keys(e.style.icon_scaling.fields).find(t=>e.style.icon_scaling.fields[t].field===e.style.icon_scaling.field)||Object.keys(e.style.icon_scaling.fields)[0];t.push(mapp.utils.html`
        <h3>${e.style.icon_scaling.title}`,mapp.ui.elements.dropdown({data_id:`iconScalingFieldsDropdown`,entries:n,callback:(t,n)=>{n.option?Object.assign(e.style.icon_scaling,{...e.style.icon_scaling.fields[n.key]}):delete e.style.icon_scaling.field,e.reload(),e.L.changed()},placeholder:e.style.icon_scaling.fields[r].title||r||e.style.icon_scaling.placeholder}))}else e.style.icon_scaling.field&&t.push(mapp.ui.elements.chkbox({checked:!!e.style.icon_scaling.field,data_id:`iconScalingFieldCheckbox-${e.key}`,label:mapp.dictionary.icon_scaling_field,onchange:t=>{t?(e.style.icon_scaling.field=e.style.icon_scaling._field,delete e.style.icon_scaling._field):(e.style.icon_scaling._field=e.style.icon_scaling.field,delete e.style.icon_scaling.field),e.L.changed()}}));return e.style.icon_scaling.icon&&(e.style.default.scale??=1,e.style.icon_scaling.maxScale??=e.style.default.scale*3,e.style.icon_scaling.minScale??=.1,e.style.icon_scaling.icon_scaling_label??=mapp.dictionary.icon_scaling_label,t.push(mapp.ui.elements.slider({callback:t=>{e.style.default.scale=Number.parseFloat(t),clearTimeout(e.style.timeout),e.style.timeout=setTimeout(()=>e.L.changed(),400)},data_id:`iconScalingSlider`,label:e.style.icon_scaling.icon_scaling_label,max:e.style.icon_scaling.maxScale,min:e.style.icon_scaling.minScale,step:e.style.default.scale/10,val:e.style.default.scale}))),e.style.icon_scaling.clusterScale&&e.style.cluster?.clusterScale&&(e.style.cluster.clusterScale??=1,t.push(mapp.ui.elements.slider({callback:t=>{e.style.cluster.clusterScale=Number.parseFloat(t),clearTimeout(e.style.timeout),e.style.timeout=setTimeout(()=>e.L.changed(),400)},data_id:`iconScalingClusterSlider`,label:mapp.dictionary.icon_scaling_cluster,max:e.style.cluster.clusterScale*3,min:0,step:e.style.cluster.clusterScale/10,val:e.style.cluster.clusterScale}))),e.style.icon_scaling.zoomInScale&&(e.style.zoomInScale??=1,t.push(mapp.ui.elements.slider({callback:t=>{e.style.zoomInScale=Number.parseFloat(t),clearTimeout(e.style.timeout),e.style.timeout=setTimeout(()=>e.L.changed(),400)},data_id:`iconScalingZoomInSlider`,label:mapp.dictionary.icon_scaling_zoom_in,max:e.style.zoomInScale*3,min:0,step:e.style.zoomInScale/10,val:e.style.zoomInScale}))),e.style.icon_scaling.zoomOutScale&&(e.style.zoomOutScale??=1,t.push(mapp.ui.elements.slider({callback:t=>{e.style.zoomOutScale=Number.parseFloat(t),clearTimeout(e.style.timeout),e.style.timeout=setTimeout(()=>e.L.changed(),400)},data_id:`iconScalingZoomOutSlider`,label:mapp.dictionary.icon_scaling_zoom_out,max:e.style.zoomOutScale*3,min:0,step:e.style.zoomOutScale/10,val:e.style.zoomOutScale}))),mapp.utils.html.node`<div>${t}`}var b=new XMLSerializer,x=24;function Le(e){let t=[];return Array.isArray(e.icon)?t.push(Re(e)):(e.icon||e.svg||e.type)&&t.push(Ve(e)),e.fillColor&&t.push(We(e)),e.strokeColor&&!e.fillColor&&t.push(Ue(e)),mapp.utils.html.node`<div class="legend-icon">${t}`}function Re(e){let t=e.width||x,n=e.height||x,r=document.createElement(`canvas`);r.width=t,r.height=n;let i=e.icon.map(e=>e.url||e.svg||S(e));return mapp.utils.svgBitmap.requestBitmaps(i).then(()=>ze(r,e,t,n)),r}function ze(e,t,n,r){let i=t.icon.length;function a(){if(--i)return;let a=t.icon.map(e=>e.legendStyle?.getImage()).filter(Boolean),o=a.map(e=>{let t=e.getImageSize()||[n,r],i=e.getScale()||1;return[t[0]*i,t[1]*i]}),s=Math.max(...o.map(e=>e[0]))||n,c=Math.max(...o.map(e=>e[1]))||r,l=Math.min(n/s,r/c),u=[s*l,c*l];a.forEach(e=>e.setScale(e.getScale()*l));let d=ol.render.toContext(e.getContext(`2d`),{pixelRatio:1,size:u});t.icon.forEach(e=>{d.setStyle(e.legendStyle),d.drawGeometry(new ol.geom.Point([u[0]*.5,u[1]*.5]))})}let o=t.icon[0].legendScale||1;for(let e of t.icon){let t=e.url||e.svg||S(e);if(!t){console.warn(`legendIcon: icon has no url, the svg or template may be missing/invalid: `,e);continue}let n=Be(t,e.legendAnchor||[.5,.5],o*(e.scale||1));e.legendStyle=new ol.style.Style({image:n});let r=n.getImage();n.getImageState()===2?a():(r.addEventListener(`load`,a),n.load())}return e}function Be(e,t,n){let r=mapp.utils.svgBitmap.iconBitmap(e);return r?new ol.style.Icon({anchor:t,img:r.image,scale:n/r.pixelRatio}):new ol.style.Icon({anchor:t,crossOrigin:e.startsWith(`data:`)?void 0:`anonymous`,scale:n,src:e})}function Ve(e){let t=e.icon?.svg||e.svg||e.icon?.url||e.url||S(e.icon||e);if(t||console.warn(`legendIcon: icon has no url, the svg or template may be missing/invalid: `,e.icon||e),t?.startsWith(`data:`))return He(t,e);let n=`
    background-position: center;
    background-repeat: no-repeat;
    background-size: contain;
    width: ${e.width+`px`||`100%`};
    height: ${e.height+`px`||`100%`};
    background-image: url(${t})`;return mapp.utils.html.node`<div style=${n}>`}function He(e,t){let n=t.width||x,r=t.height||x,i=`width: ${n}px; height: ${r}px;`,a=mapp.utils.html.node`<canvas
    style=${i}>`;return mapp.utils.svgBitmap.requestBitmaps([e]).then(()=>{let t=mapp.utils.svgBitmap.iconBitmap(e);if(!t){let t=`
        ...
        width: ${n}px;
        height: ${r}px;
        background-image: url(${e})`,i=mapp.utils.html.node`<div style=${t}>`;a.replaceWith(i);return}a.width=t.image.width,a.height=t.image.height;let i=t.image.width/t.pixelRatio,o=t.image.height/t.pixelRatio,s=Math.min(n/i,r/o);a.style.width=`${i*s}px`,a.style.height=`${o*s}px`,a.getContext(`2d`).drawImage(t.image,0,0)}),a}function S(e){if(e.type??=`dot`,Object.hasOwn(mapp.utils.svgSymbols,e.type))return mapp.utils.svgSymbols[e.type](e)}function Ue(e){let t=`M 0,${e.height/2} L ${e.width/2},${e.height/2} ${e.width/2},${e.height/2} ${e.width},${e.height/2}`;e.strokeWidth??=1,e.lineDash??=``;let n=mapp.utils.svg.node`
  <svg
    height=${e.height}
    width=${e.width}>
    <path
      ...
      stroke-dasharray=${e.lineDash} />`,r=`data:image/svg+xml,${encodeURIComponent(b.serializeToString(n))}`,i=`
    background-position: center;
    background-repeat: no-repeat;
    background-size: contain;
    width: ${e.width}px;
  ...
  <input
    ...
    <div style="
      ...
      <label>Date after
        ${n}</label>
      <label>Date before
        ${r}</label>`}function wt(e){let t=e.style.theme;t.legend??={},t.legend.grid=[],e.style.theme.style??={},e.style.theme.style.width??=24,e.style.theme.style.height??=24;let n=mapp.ui.elements.legendIcon(e.style.theme.style);return t.legend.grid.push(mapp.utils.html`
    <div 
      class="contents">
      ${n}<div class="label" style="grid-column: 2";>${e.style.theme.label}`),t.legend.node=mapp.utils.html.node`
    <div class="legend">
    <div class="contents-wrapper grid">${t.legend.grid}`,e.style.legend??=t.legend.node,e.style.legend&&e.style.legend.replaceChildren(...t.legend.node.children),t.legend.node}function O(e,t,n){if(e.field??=t.field,e.disabled??=n.filter?.current[e.field]?.ni?.includes(e.value),e.disabled||(e.style??=e._style),n.featureFields&&t.distribution===`count`){let r={value:n.featureFields[e.field]?.[e.value]};if(e.count=mapp.utils.formatNumericValue(r),!e.disabled&&!t.legend?.showEmptyCat&&!e.count)return}let r=mapp.ui.elements.legendIcon({height:24,width:24,...e._style||e.style}),i=mapp.utils.html`<div
    ...
    data-id="cluster"
    class="contents">
    ${t}${n}`}function j(e){e.legend??={},e.legend.layout??=`grid`;let t=[`contents-wrapper`,e.legend.layout];e.legend.nowrap&&t.push(`nowrap`),e.legend.classList=t.join(` `)}function M(){return mapp.utils.html`<div
    class="switch-all"
    ...
    </button>.`}function Dt(e){let t=e.style.theme;j(t),t.legend.grid=t.categories.map(n=>O(n,t,e)).filter(e=>e!==void 0),e.style.cluster&&t.legend.grid.push(A(e));let n=M();return t.legend.node=mapp.utils.html.node`
    <div class="legend">
      ${n}
      <div class=${t.legend.classList}>
        ${t.legend.grid}`,e.style.legend??=t.legend.node,e.style.legend&&e.style.legend.replaceChildren(...t.legend.node.children),t.legend.node}function N(e){e.style.theme.filterOnly=!0;let t=e.style.theme;if(j(t),!t.hideLegend){t.legend.grid=[];for(let n of t.categories)n.label=n.values?.join(`, `),n.label!==void 0&&t.legend.grid.push(O(n,t,e));return e.style.cluster&&t.legend.grid.push(A(e)),t.legend.node=mapp.utils.html.node`
    <div class="legend">
      <div class=${t.legend.classList}>
        ${t.legend.grid}`,e.style.legend??=t.legend.node,e.style.legend&&e.style.legend.replaceChildren(...t.legend.node.children),e.L.once(`postrender`,()=>{t.key===e.style.theme.key&&N(e)}),t.legend.node}}function Ot(e){let t=e.style.theme;t.filterOnly=!0,j(t),t.legend??={};let n=t.categories.filter(e=>e.value!==void 0).map(n=>{let r=`contents ${t.legend?.horizontal?`horizontal`:``}`,i=mapp.ui.elements.legendIcon({height:24,width:24,...n._style||n.style});n.label??=n.value;let a=`label switch ${n.disabled?`disabled`:``}`;return mapp.utils.html`<div 
        data-id=${n.value}
        class=${r}>
        <div 
          style="height: 24px; width: 24px; grid-column: 1;">
  ...
  class="notranslate material-symbols-outlined active"
    ...
    data-id=resetall
    class="flat underline"
    onclick=${t=>{e.filter.list.forEach(t=>mapp.ui.layers.filters.resetFilter(e,t))}}>${mapp.dictionary.filter_reset_all}`,e.filter.count=mapp.utils.html.node`<span class="bold">`,e.changeEndCallbacks.push(F),e.showCallbacks.push(F),e.hideCallbacks.push(e=>{e.filter.clearAll?.checkVisibility()&&e.filter.feature_count.style.setProperty(`display`,`none`)}),e.filter.count_meta??=mapp.dictionary.filter_count,e.filter.feature_count=mapp.utils.html.node`
    ...
    <div class="link-with-img">
      ...
      data-src=${e.value}
      onclick=${t=>B(t,e,mapp.dictionary.remove_image_confirm)}>delete`;return mapp.utils.html.node`<div class="img-item"><img
      style="width: 100%"
      src=${e.value}
      onclick=${mapp.ui.utils.imagePreview}>
      ${t}`}else if(e.edit)return mapp.utils.html.node`<div
      class="drag_and_drop_zone"
      ondrop=${t=>{t.preventDefault(),R(t,e)}}>
      <p><span class="notranslate material-symbols-outlined add">add_a_photo</span>${mapp.dictionary.drag_and_drop_image}</p>
      <input
        type="file"
        accept="image/*;capture=camera" onchange=${t=>{R(t,e)}}>`}function sn(e){let t=[];if(e.value?.map(n=>{let r=e.edit&&mapp.utils.html`<button title="${mapp.dictionary.delete}"
      class="notranslate material-symbols-outlined color-danger delete"
      data-name=${n.replace(/^.*\//,``).replace(/\.([\w-]{3})/,``)}
      data-src=${n}
      onclick=${t=>B(t,e,mapp.dictionary.remove_image_confirm)}>delete`;t.push(mapp.utils.html`<div class="img-item"><img
      src=${n}
      onclick=${mapp.ui.utils.imagePreview}>
      ...
      <input
        type="file"
        accept="image/*;capture=camera" onchange=${t=>{R(t,e)}}>`;t.push(n)}if(t.length)return mapp.utils.html.node`<div class="images-grid">${t}`}function cn(e){let t=[];if(e.value?.map(n=>{let r=e.edit&&mapp.utils.html`<button
      title="${mapp.dictionary.delete}"
      class="notranslate material-symbols-outlined color-danger delete"
      data-name=${n.replace(/^.*\//,``).replace(/\.([\w-]{3})/,``)}
      data-href=${n}
      onclick=${t=>B(t,e,mapp.dictionary.remove_document_confirm)}>delete`,i=n.replace(/^.*\//,``).replace(/\.([\w-]{3})/,``);t.push(mapp.utils.html`<div class="link-with-img">
      ...
      <input type="file"
        ...
        onchange=${t=>R(t,e)}>`;t.unshift(n)}if(t.length)return mapp.utils.html.node`<div>${t}`}async function R(e,t){let n=new FileReader,r=e.type===`drop`?e.dataTransfer?.files[0]:e.target.files[0];if(!r)return;t.location.view?.classList.add(`disabled`);let i={documents:un,image:z,images:z};n.onload=e=>i[t.type](e,t,r),n.readAsDataURL(r)}function z(e,t,n){let r=new Image;r.onload=async()=>ln(t,r,n),r.src=e.target.result}async function ln(e,t,n){let r=document.createElement(`canvas`);e.max_size??=1024,t.width>t.height&&t.width>e.max_size?(t.height*=e.max_size/t.width,t.width=e.max_size):t.height>e.max_size&&(t.width*=e.max_size/t.height,t.height=e.max_size),r.width=t.width,r.height=t.height,r.getContext(`2d`).drawImage(t,0,0,t.width,t.height);let i=await H(e,{public_id:n.name.replace(/^.*\//,``).replace(/\.([\w-]{3})/,``)+e.suffix_date?`@${Date.now()}`:``});if(!i)return;let a=new FormData;a.append(`file`,r.toDataURL(`image/jpeg`,.5));let o=await fetch(i,{body:a,method:`post`});if(!o.ok){mapp.ui.elements.alert(`Cloudinary Image upload failed!`),e.location.view?.classList.remove(`disabled`);return}let s=await o.json();e.type===`image`?e.value=s.secure_url:e.value=Array.isArray(e.value)?e.value.concat([s.secure_url]):[s.secure_url],V(e)}async function un(e,t,n){let r=new Date,i=`${r.getMonth()+1}-${r.getDate()}T${r.getHours()}:${r.getMinutes()}`,a=n.name.substring(n.name.lastIndexOf(`.`)),o=await H(t,{public_id:`${n.name.replace(a,``)}-${i}${a}`});if(!o)return;let s=new FormData;s.append(`file`,e.target.result.toString());let c=await fetch(o,{body:s,method:`post`});if(!c.ok){mapp.ui.elements.alert(`Cloudinary Document upload failed!`),t.location.view?.classList.remove(`disabled`);return}let l=await c.json();t.value=Array.isArray(t.value)?t.value.concat([l.secure_url]):[l.secure_url],V(t)}async function B(e,t,n){if(!await mapp.ui.elements.confirm({text:n}))return;let r=await H(t,{destroy:!0,public_id:decodeURIComponent(e.target.dataset.name)});if(!r)return;await fetch(r,{method:`post`});let i=new Set(t.value);i.delete(e.target.dataset.src||e.target.dataset.href),t.type===`image`?t.value=null:t.value=i.size?Array.from(i):null,V(t)}async function V(e){e.location.view?.classList.add(`disabled`),await mapp.utils.xhr({body:JSON.stringify({[e.field]:e.value}),method:`POST`,url:`${e.location.layer.mapview.host}/api/query?`+mapp.utils.paramString({id:e.location.id,layer:e.location.layer.key,locale:e.location.layer.mapview.locale.key,table:e.location.table,template:e.location.updateTemplate})}),e.node.replaceChildren(mapp.utils.html.node`<div class="label">${e.title}`,I[e.type](e)),e.location.view?.classList.remove(`disabled`)}async function H(e,t){let n=mapp.utils.paramString({...t,folder:e.cloudinary_folder}),r=await mapp.utils.xhr({responseType:`text`,url:`${e.location.layer.mapview.host}/api/sign/cloudinary?${n}`});return r instanceof Error&&(console.error(r),e.location.view?.classList.remove(`disabled`)),r}function dn(e){if(e.value!==void 0&&(e.data=e.value),e.data?.length===0&&(e.data=null),e.layer??=e.location.layer,fn(e),e.target instanceof HTMLElement){if(!e.display&&typeof e.create==`function`)return mapp.utils.html.node`
    ${e.chkbox||``}
    ...
    class="val"
    style=${e.css_val}>
    ${t}`}function hn(e){if(e.format??=`GeoJSON`,e.mapview??=e.location.layer.mapview,typeof e.value==`string`&&(e.value=JSON.parse(e.value)),e.srid??=e.location.layer.srid,e.zIndex??=e.location.layer.zIndex+1||99,e.display??=!1,e.edit?.draw&&(e.draw=e.edit.draw),e._edit?.draw&&delete e.draw,!e.value&&!e.draw&&!e.api){e.location.removeLayer(e);return}e.style!==null&&(e.style={...e.location.style,...e.style},e.Style??=mapp.utils.style(e.style)),e.show??=_n,e.hide??=vn,e.getExtent??=gn,e.modify??=xn,e.label??=`Geometry`,e.disabled=!e.value&&!e.api||e.error,e.chkbox=mapp.ui.elements.chkbox({checked:e.display,data_id:`chkbox-${e.key}`,disabled:e.disabled,label:e.label,onchange:t=>{t?e.show():e.hide()}}),Array.isArray(e.elements)||(e.elements=e.api_elements||[],Sn(e),yn(e)),e.edit||delete e.elements;let t=mapp.ui.elements.legendIcon({height:24,width:24,...e.style});return e.display&&e.show(),mapp.utils.html.node`
    <div class="flex-spacer">${e.chkbox}${t}</div>
    ${e.elements}`}function gn(){if(this.display&&this.L)return this.L.getSource().getExtent()}async function _n(){if(this.disabled)return;this.location.removeLayer(this),this.display=!0;let e=this.chkbox?.querySelector(`input`);if(e&&(e.checked=!0),!this.value&&this.api){if(this.blocking&&this.location.view?.classList.add(`disabled`),await this.api(this),this.blocking)return;this.value||(this.disabled=!0)}this.value&&(this.L=this.location.layer.mapview.geometry(this),this.location.Layers.push(this))}function vn(){this.display=!1,this.location.removeLayer(this)}function yn(e){e.edit&&e.value&&(e.edit.modify_label??=mapp.dictionary.modify_geometry,e.edit.modify_btn=mapp.utils.html.node`
    <button
      class="action wide"
      data-id="modify-btn"
    ...
    <span style="color: var(--color-danger)">${e.edit.delete_label}</span>`))}async function bn(e){if(await e.location.confirmUpdate(t)===null)return;t();function t(){e.display=!1,e.newValue=null,e.location.update(n)}function n(){delete e.elements,e.location.renderLocationView()}}async function xn(){let e=this;if(await e.location.confirmUpdate(()=>{e.location.renderLocationView()})===null){e.edit.modify_btn.classList.remove(`active`);return}if(!e.hideHelp){let e={content:mapp.utils.html.node`<li>
        ...
        <ul>${mapp.dictionary.edit_dialog_save}</ul>`,header:mapp.utils.html`<h3>${mapp.dictionary.edit_dialog_title}</h3>`};mapp.ui.elements.helpDialog(e)}!e.display&&e.show(),e.location.layer.mapview.Map.removeLayer(e.L);let t=e.L.getSource().getFeatures()[0].clone();e.location.layer.mapview.interactions.modify({Feature:t,layer:e.location.layer,snap:e.edit.snap,srid:e.srid,callback:t=>{e.edit.modify_btn.classList.remove(`active`),U(t,e)}})}function Sn(e){e.draw&&(Object.keys(e.draw).forEach(t=>{if(e.draw[t]===!0&&(e.draw[t]={}),mapp.ui.elements.drawing[t]){e.draw[t].callback??=n=>{e.draw[t].btn.classList.remove(`active`),U(n,e)};let n=mapp.ui.elements.drawing[t](e);e.draw.dialog&&e.edit?(e.draw.content??=[],n instanceof HTMLElement&&e.draw.content.push(n)):n instanceof HTMLElement&&e.elements.push(n)}}),mapp.ui.elements.drawer({layer:e,key:`draw`,name:`Draw`,icon:`new_label`}),e.edit&&e.draw?.dialog?.btn&&e.elements.push(e.draw.dialog.btn))}function U(e,t){if(delete t.mapview.interaction,mapp.ui.elements.helpDialog(),!e){setTimeout(()=>{!t.mapview.interaction&&t.mapview.interactions.highlight()},400),t.location.renderLocationView();return}t.newValue=e.geometry,t.location.update(n);function n(){delete t.elements,t.location.renderLocationView()}}function Cn(e){e.css_val??=``,e.inline&&console.warn(`${e.key} - json entries cannot be inline, please remove inline true from entry`);let t=mapp.utils.html.node`<div
    class="val"
    style=${e.css_val}>`;e.data=e.newValue||e.value;function n(e){return e.filter(e=>e.text!==`tree`).filter(e=>e.text!==`text`).filter(e=>e.text!==`table`).filter(e=>e.type!==`separator`).filter(e=>e.className!==`jse-undo`).filter(e=>e.className!==`jse-redo`).filter(e=>e.className!==`jse-search`).filter(e=>e.className!==`jse-contextmenu`).filter(e=>e.className!==`jse-sort`).filter(e=>e.className!==`jse-transform`)}e.jsoneditor=mapp.ui.elements.jsoneditor({data:e.data,props:{mode:`text`,onChange:r,onRenderMenu:n,readOnly:!e.edit},target:t});function r(t,n,r){r.contentErrors||(e.newValue=JSON.parse(t.text),e.location.view?.dispatchEvent(new CustomEvent(`valChange`,{detail:e})))}return t}function wn(e){e.hideLayer&&e.location.layer.hide();let t=`layer-key ${e.location.layer.display?`active`:``}`;return mapp.utils.html.node`<div>
    <button 
      class=${t}
      title="${mapp.dictionary.layer_visibility}"
      onclick="${t=>{t.target.classList.toggle(`active`)?e.location.layer.show():e.location.layer.hide()}}">${e.location.layer.name}`}function W(e){return Tn(e),e.mapview??=e.location.layer.mapview,En(e),e.zIndex??=e.location.layer.zIndex++,Dn(e),e.panel??=mapp.utils.html.node`<div class="entry-layer">`,e.panel}function Tn(e){e.value!==void 0&&(e.data=e.value,e.data?.length===0&&(e.data=null)),(e.featureSet||e.featureLookup)&&(!e.query&&!e.data?(e.disabled=!0,e.display_toggle?.classList.add(`disabled`)):(e.disabled=!1,e.display_toggle?.classList.remove(`disabled`)))}function En(e){if(!e.layer)return;e.key=e.layer;let t=structuredClone(e.mapview.locale.layers.find(t=>t.key===e.layer));if(!t){console.warn(`Layer [${e.layer}] not found in mapview.locale`);return}let n=Object.keys(t).filter(t=>!Object.hasOwn(e,t)).reduce((e,n)=>(e[n]=t[n],e),{});Object.assign(e,n),e.params??={},e.params.layer_template??=e.layer,delete e.layer}async function Dn(e){if(e.L&&e.display){e.show();return}else if(e.L)return;e.source_key=e.key,await mapp.layer.decorate(e),e.L&&(e.location.Layers.push(e),e.key+=`-${e.location.id}`,e.L.set(`key`,e.key),e.show=On,e.hide=An,e.mapview.layers[e.key]=e,e.display_toggle=mapp.ui.elements.chkbox({checked:e.display,data_id:`${e.key}-display`,disabled:e.disabled,label:e.name,onchange:t=>{t?e.show():e.hide()}}),e.tables&&(e.tableCurrent()||e.display_toggle.classList.add(`disabled`),e.changeEndCallbacks.push(()=>{e.tableCurrent()?e.display_toggle.classList.remove(`disabled`):e.display_toggle.classList.add(`disabled`)})),e.panel.append(e.display_toggle),e.meta&&e.panel.append(mapp.ui.layers.panels.meta(e)),e.style.elements??=[`labels`,`label`,`hovers`,`hover`,`icon_scaling`,`opacitySlider`,`themes`,`theme`],e.style.panel=mapp.ui.elements.layerStyle.panel(e),e.style.default&&(e.style.default={...e.location?.style,...e.style.default}),e.style.panel?.style.setProperty(`display`,`none`),e.style.panel&&e.panel.append(e.style.panel),e.location.removeCallbacks.push(()=>{typeof e.remove==`function`&&e.remove()}),e.display&&e.show())}async function On(){let e=this;if(e.query){let t=mapp.utils.queryParams(e),n=mapp.utils.paramString(t);if(e.data=await mapp.utils.xhr(`${e.mapview.host}/api/query?${n}`),!e.data){e.disabled=!0,e.display_toggle?.classList.add(`disabled`),e.panel.replaceChildren(e.display_toggle);return}}kn(e),e.style.panel?.style.setProperty(`display`,`block`),e.display=!0;try{e.mapview.Map.addLayer(e.L)}catch{}typeof e.reload==`function`&&e.reload(),e.showCallbacks?.forEach(t=>typeof t==`function`&&t(e))}function kn(e){if(e.data){if(e.featureSet){let t=Array.isArray(e.data)?e.data:[e.data];e.featureSet=new Set(t);return}if(e.featureLookup){e.featureLookup=Array.isArray(e.data)?e.data:[e.data];return}e.features=e.data,e.setSource(e.features)}}function An(){this.display=!1,this.style.panel?.style.setProperty(`display`,`none`),this.mapview.Map.removeLayer(this.L),this.hideCallbacks?.forEach(e=>typeof e==`function`&&e(this))}function G(e){let t=mapp.ui.elements.reportLink(e);return mapp.utils.html.node`<div class="val">${t}`}function K(e){if(e.edit)return jn(e);if(!(e.value===null||Number.isNaN(Number(e.value))))return mapp.utils.formatNumericValue(e),mapp.utils.html.node`<div 
    class="val"
    style=${e.css_val}
    >${e.stringValue}`}function jn(e){e.edit.callback??=()=>{e.location.view?.dispatchEvent(new CustomEvent(`valChange`,{detail:e}))},e.edit.min??=e.min||-2147483648,e.edit.max??=e.max||2147483647,e.edit.step??=e.step||e.type===`integer`?1:.1,Object.assign(e,e.edit);let t=e.value??e.newValue;return e.edit.range&&!Number.isNaN(Number(t))&&t>e.min&&t<e.max?mapp.ui.elements.slider(e):mapp.ui.elements.numericInput(e)}var Mn=e=>(e.pills??=e.value||[],mapp.ui.elements.pills(e),e.container);function Nn(e){if(!Array.isArray(e.value)){console.warn(`Entry type pin requires a value array.`);return}return e.srid??=e.location.layer.srid,e.display??=e.display===void 0,e.zIndex??=1/0,e.Style??=e.style?mapp.utils.style(e.style):e.location.pinStyle,e.show??=Pn,e.hide??=Fn,e.getExtent??=In,e.geometry={coordinates:e.value,type:`Point`},e.display&&e.show(),e.label??=mapp.dictionary.pin,e.chkbox??=mapp.ui.elements.chkbox({checked:e.display,label:e.label,onchange:t=>{t?e.show():e.hide()}}),e.chkbox}function Pn(){this.disabled||(this.location.removeLayer(this),this.display=!0,this.L=this.location.layer.mapview.geoJSON(this),this.location.Layers.push(this))}function Fn(){this.display=!1,this.location.removeLayer(this)}function In(){return this.buffer??=0,this.buffer=Number.parseInt(this.buffer)||200,ol.extent.buffer(this.L.getSource().getExtent(),this.buffer)}function Ln(e){return e.textarea||(e.textarea=mapp.utils.html.node`<textarea
      class="val"
      style="auto; min-height: 50px;">`,e.callback??=async(e,t)=>{t.textarea.value=e},mapp.utils.ping(e),e.location.removeCallbacks.push(()=>{e.callback=!1})),e.textarea}function Rn(e){if(!e.query){console.warn(`You must provide a query to use "type": "query_button".`);return}return e.label??=`Run query:${e.query}`,mapp.utils.html.node`
    <button 
      class="flat wide bold"
      onclick=${()=>zn(e)}>${e.label}`}async function zn(e){e.updated_fields&&(console.warn(`entry.updated_fields is deprecated, please use entry.dependents instead.`),e.dependents??=e.updated_fields),e.location.view.classList.add(`disabled`),e.queryparams??={},e.queryparams.template=e.query;let t=mapp.utils.paramString(mapp.utils.queryParams(e));e.host??=e.location.layer.mapview.host+`/api/query`;let n=await mapp.utils.xhr(`${e.host}?${t}`);if(n instanceof Error){mapp.ui.elements.alert({text:mapp.dictionary.query_failed}),e.location.view.classList.remove(`disabled`);return}e.value=n,e.alert&&mapp.ui.elements.alert({text:e.alert}),e.reload&&e.location.layer.reload(),e.dependents&&await e.location.syncFields(e.dependents),e.location.view.dispatchEvent(new Event(`updateInfo`)),e.location.view.classList.remove(`disabled`)}var Bn=e=>{let t=document.querySelector(`[data-id=${e.target}]`);return e.tab_style=`border-bottom: 3px solid ${e.location.style.strokeColor}`,t.dispatchEvent(new CustomEvent(`addTab`,{detail:e})),e.display&&e.show(),mapp.ui.elements.chkbox({checked:!!e.display,label:e.label,onchange:t=>{e.display=t,e.display?e.show():e.remove()}})};function Vn(e){if(!(!e.edit&&!e.value))return e.edit?Hn(e):mapp.utils.html.node`
    <div
      class="val"
      style=${e.css_val}>
      ${e.prefix}${e.value}${e.suffix}`}function Hn(e){return e.edit.options?(e.container=mapp.utils.html.node`<div>${mapp.dictionary.loading}`,Wn(e),e.container):mapp.utils.html.node`<input
    type="text"
    maxlength=${e.edit.maxlength}
    value="${e.newValue||e.value||``}"
    placeholder="${e.edit.placeholder||``}"
    onkeyup=${t=>Un(t,e)}>`}function Un(e,t){t.newValue=t.edit.arraySeparator?e.target.value.split(t.edit.arraySeparator):e.target.value,t.location.view?.dispatchEvent(new CustomEvent(`valChange`,{detail:t}))}async function Wn(e){if(e.edit.dynamic===!0&&(e.edit.options=[]),!e.edit.options.length){(e.jsonb_field||e.json_field)&&(e.edit.query??=`distinct_values_json`),e.edit.query??=`distinct_values`;let t=mapp.utils.paramString({field:e.json_field||e.jsonb_field||e.field,filter:e.location.layer.filter?.current,id:e.location.id,key:e.jsonb_key||e.json_key,layer:e.location.layer.key,locale:e.location.layer.mapview.locale.key,table:e.location.layer.tableCurrent(),template:e.edit.query}),n=await mapp.utils.xhr(`${e.location.layer.mapview.host}/api/query?${t}`);if(n===null){e.container.innerHTML=`${mapp.dictionary.no_options_available}`;return}e.edit.options=[n].flat().map(e=>Object.values(e)[0])}if(e.edit.radio){Gn(e);return}let t=e.edit.options.map(e=>({option:e===null?null:typeof e==`string`&&e||Object.values(e)[0],title:e===null?null:typeof e==`string`&&e||Object.keys(e)[0]})),n=t.find(t=>t.option===e.value),r=e.value===void 0?e.edit.placeholder:e.value;mapp.utils.render(e.container,mapp.ui.elements.dropdown({callback:(t,n)=>{e.newValue=n.option,e.location.view?.dispatchEvent(new CustomEvent(`valChange`,{detail:e}))},entries:t,placeholder:r,span:n?.title||e.value}))}function Gn(e){let t=e.edit.options.map(n=>{let r={data_id:n,name:e.field,label:n,onchange:()=>{e.newValue=t.find(e=>e.querySelector(`input[type="radio"]:checked`)).querySelector(`input[type="radio"]`).dataset.id,e.location.view?.dispatchEvent(new CustomEvent(`valChange`,{detail:e}))}};return mapp.ui.elements.radio(r)});if(e.value){let n=t.find(t=>t.querySelector(`input[type="radio"]`).dataset.id===e.value);n&&(n.querySelector(`input[type="radio"]`).checked=!0)}mapp.utils.render(e.container,mapp.utils.html.node`${t}`)}function Kn(e){let t=e.type===`html`?``:e.value;e.edit&&(t=mapp.utils.html`
    <textarea
