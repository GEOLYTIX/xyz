...
function init(_xyz) {
    ...
    if (_xyz.view_mode === 'mobile') require('./mobile_interface')();
    if (_xyz.view_mode === 'desktop') require('./desktop_interface')();

    // Initiate hooks module.
    require('./hooks')(_xyz);

    // Initiate locales module.
    require('./locales')(_xyz);
    ...
    require('./locations')(_xyz);

    // Initialize gazetteer module.
    if (_xyz.view_mode != 'report') require('./gazetteer')(_xyz);

    // Initialize locate module.
    if (_xyz.locate && _xyz.view_mode != 'report') require('./locate')(_xyz);
