export default (_xyz, layer) => {
  ...
  group.container = _xyz.utils.hyperHTML.wire()`
  <div class="drawer drawer-group expandable-group">`;

  _xyz.layers.listview.node.appendChild(group.container);

  
  // Create layer group header.
  group.header = _xyz.utils.hyperHTML.wire()`
  ...
  group.visible = _xyz.utils.hyperHTML.wire()`
    <i
    class="material-icons cursor noselect btn_header hide-group"
