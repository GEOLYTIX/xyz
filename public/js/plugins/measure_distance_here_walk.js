      ...
      <button
        ...
        function begin(params) {
            ...
            _xyz.mapview.interaction.draw.interaction.on('drawstart', e => {
                ...
                metricFunction(e.feature.getGeometry(), summary)
            ...
            geometry.on('change', () => {
                ...
                _xyz.mapview.popup.create({
                    content: _xyz.utils.html.node `<div style="padding: 5px; min-width: 100px; font-size: smaller;">
                                <b>Driving</b></br>
                                Distance ${(parseFloat(params.vehicle.length/1000).toFixed(2)).toString().toLocaleString('en-GB')} km<br/>
                                Time ${Math.round(params.vehicle.duration/60)} min<br/>
                                <b>Walking</b></br>
                                Distance ${(parseFloat(params.pedestrian.length/1000).toFixed(2)).toString().toLocaleString('en-GB')} km<br/>
