export default _xyz => {
  ...
  function begin(params) {
    ...
    _xyz.mapview.edit.callback = params.callback;

    _xyz.mapview.edit.location = params.location;
    ...
    _xyz.mapview.edit.interaction = new _xyz.mapview.lib.interaction.Modify({
      source: _xyz.mapview.edit.location.Layer.getSource(),
    ...
    _xyz.map.addInteraction(_xyz.mapview.edit.interaction);
