...
eleventy, markdown-it, and the syntaxhighlight plugin are **not included** as dependencies in the package.json and must be installed locally or globally if you intend to compile the doc pages from the eleventy folder.
